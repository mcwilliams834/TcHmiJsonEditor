...
! function(e, t) {
  ...
  return i = {}, o.m = n = [function(e, t, n) {
    ...
    function v(e) {
      return null === e ? "null" : void 0 === e ? "undefined" : e instanceof Number || "number" == typeof e ? "number" : e instanceof String || "string" == typeof e ? "string" : e instanceof Boolean || "boolean" == typeof e ? "boolean" : e instanceof RegExp ? "regexp" : x(e) ? "array" : "object"
    }
    var y = /^https?:\/\/\S+$/;
    ...
    function S(e, t) {
      var n = e.className.split(" "),
        t = n.indexOf(t); - 1 !== t && (n.splice(t, 1), e.className = n.join(" "))
    }
    ...
    function A(e) {
      var t;
      document.createRange && window.getSelection && window.getSelection() && (t = document.createRange(), e.container.firstChild || e.container.appendChild(document.createTextNode("")), t.setStart(e.container.firstChild, e.startOffset), t.setEnd(e.container.firstChild, e.endOffset), I(t))
    }
    ...
    function M() {
      var e;
      return -1 === V && (e = -1, "undefined" != typeof navigator && "Microsoft Internet Explorer" === navigator.appName && (null != /MSIE ([0-9]+[.0-9]+)/.exec(navigator.userAgent) && (e = parseFloat(RegExp.$1))), V = e), V
    }
    var V = -1;
    ...
    function L(e, t, n, i) {
      if (e.addEventListener) return void 0 === i && (i = !1), "mousewheel" === t && B() && (t = "DOMMouseScroll"), e.addEventListener(t, n, i), n;
      if (e.attachEvent) {
        i = function() {
    ...
    function R(e, t, n, i) {
      e.removeEventListener ? (void 0 === i && (i = !1), "mousewheel" === t && B() && (t = "DOMMouseScroll"), e.removeEventListener(t, n, i)) : e.detachEvent && e.detachEvent("on" + t, n)
    }
    ...
    function re(e, t) {
      var n = {};
      if (Array.isArray(e))
        for (var i = Math.min(e.length, c), o = 0; o < i; o++) ! function t(n, i, o, r) {
          (Array.isArray(n) || ue(n)) && !r || (i[o || ""] = !0), ue(n) && Object.keys(n).forEach(function(e) {
            t(n[e], i, o + "." + e, r)
          })
        }(e[o], n, "", t);
      else n[""] = !0;
    ...
    function fe(n, e) {
      ...
      for (var t = 0; t < n.length; ++t) {
        var i = function(t) {
          if (!("error" === n[t].type ? e.find(function(e) {
    ...
    var t = n(19),
      ...
      s = "en",
      o = "undefined" != typeof navigator ? navigator.language || navigator.userLanguage : void 0,
      a = i.find(function(e) {
        return e === o
      }) || s;
    ...
    function c(e) {
      if (e)
        for (var t in e) ! function(t) {
          i.find(function(e) {
            return e === t
          }) || i.push(t), r[t] = Object.assign({}, r[s], r[t], e[t])
        }(t)
    }
    ...
    function d(e, t, n) {
      ...
      if (t)
        for (var o in t) i = i.replace("${" + o + "}", t[o]);
      return i
    }
  }, function(e, t, n) {
    "use strict";
      ...
      return e = l, (t = [{
        ...
        value: function() {
          ...
          return this.dom.items.forEach(function(e) {
            t.push(e.button), e.buttonExpand && t.push(e.buttonExpand), e.subItems && e === n.expandedItem && e.subItems.forEach(function(e) {
        ...
        value: function(n) {
          ...
          t && (t.ul.style.height = "0", t.ul.style.padding = "", setTimeout(function() {
            o.expandedItem !== t && (t.ul.style.display = "", Object(d.removeClassName)(t.ul.parentNode, "jsoneditor-selected"))
          }, 300), this.expandedItem = void 0), e || ((i = n.ul).style.display = "block", i.clientHeight, setTimeout(function() {
            if (o.expandedItem === n) {
              for (var e = 0, t = 0; t < i.childNodes.length; t++) e += i.childNodes[t].clientHeight;
              i.style.height = e + "px", i.style.padding = "5px 10px"
            }
          }, 0), Object(d.addClassName)(i.parentNode, "jsoneditor-selected"), this.expandedItem = n)
        }
      }, {
        key: "_onKeyDown",
        value: function(e) {
          var t, n, i, o, r = e.target,
            s = e.which,
            a = !1;
          27 === s ? (this.selection && Object(d.setSelection)(this.selection), this.anchor && this.anchor.focus(), this.hide(), a = !0) : 9 === s ? e.shiftKey ? 0 === (n = (t = this._getVisibleButtons()).indexOf(r)) && (t[t.length - 1].focus(), a = !0) : (n = (t = this._getVisibleButtons()).indexOf(r)) === t.length - 1 && (t[0].focus(), a = !0) : 37 === s ? ("jsoneditor-expand" === r.className && (n = (t = this._getVisibleButtons()).indexOf(r), (i = t[n - 1]) && i.focus()), a = !0) : 38 === s ? (n = (t = this._getVisibleButtons()).indexOf(r), (i = t[n - 1]) && "jsoneditor-expand" === i.className && (i = t[n - 2]), (i = i || t[t.length - 1]) && i.focus(), a = !0) : 39 === s ? (n = (t = this._getVisibleButtons()).indexOf(r), (o = t[n + 1]) && "jsoneditor-expand" === o.className && o.focus(), a = !0) : 40 === s && (n = (t = this._getVisibleButtons()).indexOf(r), (o = t[n + 1]) && "jsoneditor-expand" === o.className && (o = t[n + 2]), (o = o || t[0]) && (o.focus(), a = !0), a = !0), a && (e.stopPropagation(), e.preventDefault())
        }
    ...
    "use strict";
    n.r(t), n.d(t, "showSortModal", function() {
      return s
    });
    var t = n(14),
      i = n.n(t),
    ...
    function s(e, t, s, n) {
      ...
      i()({
        ...
        a.forEach(function(e) {
          var t, n = document.createElement("option");
          n.text = "" === (t = e) ? "@" : "." === t[0] ? t.slice(1) : t, n.value = e, i.appendChild(n)
        }), i.value = l || a[0], r(c || "asc"), o.onclick = function(e) {
          r(e.target.getAttribute("data-value"))
        }, n.onclick = function(e) {
          e.preventDefault(), e.stopPropagation(), t.close(), s({
            path: i.value,
            direction: o.value
          })
    ...
    "use strict";
    n.r(t), n.d(t, "showTransformModal", function() {
      return a
    });
    var t = n(14),
      i = n.n(t),
    ...
    function S(e, t, n, i) {
      return "boolean" == typeof e || e instanceof Boolean || null === e || "number" == typeof e || e instanceof Number || "string" == typeof e || e instanceof String || e instanceof Date ? JSON.stringify(e) : Array.isArray(e) ? function(e, t, n, i) {
        for (var o = t ? n + t : void 0, r = t ? "[\n" : "[", s = 0; s < e.length; s++) {
          var a = e[s];
          if (t && (r += o), r += void 0 !== a && "function" != typeof a ? S(a, t, o, i) : "null", s < e.length - 1 && (r += t ? ",\n" : ","), r.length > i) return r + "..."
        }
        return r += t ? "\n" + n + "]" : "]"
      }(e, t, n, i) : e && "object" === r(e) ? function(e, t, n, i) {
        var o, r = t ? n + t : void 0,
          s = !0,
          a = t ? "{\n" : "{";
        if ("function" == typeof e.toJSON) return S(e.toJSON(), t, n, i);
        for (o in e)
          if (function(e, t) {
              return Object.prototype.hasOwnProperty.call(e, t)
            }(e, o)) {
            var l = e[o];
            if (s ? s = !1 : a += t ? ",\n" : ",", a += t ? r + '"' + o + '": ' : '"' + o + '":', (a += S(l, t, r, i)).length > i) return a + "..."
          } return a += t ? "\n" + n + "}" : "}"
      }(e, t, n, i) : void 0
    }
    ...
    function a(e) {
      ...
      i()({
        ...
        Array.isArray(T) || (n.style.fontStyle = "italic", n.textContent = "(wizard not available for objects, only for arrays)"), Object(k.getChildPaths)(x).forEach(function(e) {
          var t = g(e),
        ...
        p.on("selectr.change", b), f.on("selectr.change", b), a.oninput = b, n.on("selectr.change", b), i.on("selectr.change", b), m.on("selectr.change", b), e.querySelector(".pico-modal-contents").onclick = function(e) {
          "A" !== e.target.nodeName && e.preventDefault()
        };
        var v = Object(k.debounce)(function() {
          try {
            var e = E(T, h.value);
            u.className = "jsoneditor-transform-preview", u.value = (t = e, n = 2, e = N.b, "number" == typeof n ? 10 < n ? i = j(" ", 10) : 1 <= n && (i = j(" ", n)) : "string" == typeof n && "" !== n && (i = n), (t = S(t, i, "", e)).length > e ? (i = t, ("number" == typeof(e = e) ? i.slice(0, e) : i) + "...") : t), o.disabled = !1
          } catch (e) {
        ...
        function y(e, t) {
          try {
            ...
            var n = 'Error: an error happened when executing "createQuery": ' + (e.message || e.toString());
            h.value = "", o.disabled = !0, u.className = "jsoneditor-transform-preview jsoneditor-error", u.value = n
          }
        }
        ...
        function b() {
          ...
          if (r.value && s.value && a.value && (e.filter = {
            ...
            for (var t, n = [], i = 0; i < d.options.length; i++) d.options[i].selected && (t = d.options[i].value, n.push(t));
            e.projection = {
              fields: n
            }
          }
        ...
        h.oninput = v, o.onclick = function(e) {
          e.preventDefault(), e.stopPropagation(), t.close(), _(h.value)
        }, y(x, {}), setTimeout(function() {
          h.select(), h.focus(), h.selectionStart = 3, h.selectionEnd = 3
        })
      }).afterClose(function(e) {
        e.destroy()
      }).show()
    ...
    e.exports = function() {
        ...
        j += O, I = x, O = "",
          function() {
            ...
            ! function() {
              if (l(N) || "-" === N) {
                if (I = m, "-" === N) {
                  if (O += N, D(), !l(N)) throw new o("Invalid number, digit expected", k)
                } else "0" === N && (O += N, D());
                for (; l(N);) O += N, D();
                if ("." === N) {
                  if (O += N, D(), !l(N)) throw new o("Invalid number, digit expected", k);
                ...
                if ("e" === N || "E" === N) {
                  if (O += N, D(), "+" !== N && "-" !== N || (O += N, D()), !l(N)) throw new o("Invalid number, digit expected", k);
                  for (; l(N);) O += N, D()
                }
                return
              }! function() {
                if (function(e) {
                  ...
                  for (O += '"', I = g, D();
                    ...
                    if ("'" !== N) throw new o('Invalid escape character "\\' + N + '"', k);
                    O += "'", D()
                  } else _[N] ? O += _[N] : O += '"' === N ? '\\"' : N, D();
                  if (h(N) !== e) throw new o("End of string expected", k - O.length);
                  return O += '"', D()
                }! function() {
                  if (a(N)) {
                    ...
                    if (c(N) || d(N)) {
                      ...
                      if ("/" === N && "/" === S[k + 1]) {
                        ...
                        for (;
                          "" !== N;) O += N, D();
                        throw new o('Syntax error in part "' + O + '"', k - O.length)
                      }()
                    }()
                  }()
                }()
        ...
        if (I !== f || "{" !== O) ! function() {
          if (I === f && "[" === O) {
            ...
            if (I === g) {
              for (P(); I === f && "+" === O;) {
                var e;
                O = "", P(), I === g && (e = j.lastIndexOf('"'), j = j.substring(0, e) + O.substring(1), O = "", P())
              }
              return
            }! function() {
              if (I === m) return P();
              ! function() {
                if (I === v) {
                  ...
                  var e = O,
                    t = j.length;
                  if (O = "", P(), I === f && "(" === O) return O = "", P(), F(), I === f && ")" === O && (O = "", P(), I === f && ";" === O && (O = "", P()));
                  for (j = function(e, t, n) {
                      return e.substring(0, n) + t + e.substring(n)
                    }(j, '"' + e, t); I === v || I === m;) P();
                  return j += '"'
                }! function() {
                  throw new o("" === O ? "Unexpected end of json string" : "Value expected", k - O.length)
                }()
              }()
            }()
          }()
          ...
          for (;;) {
            if (I !== v && I !== m || (I = g, O = '"' + O + '"'), I !== g) throw new o("Object key expected", k - O.length);
            if (P(), I === f && ":" === O) P();
            else {
      ...
      return function(e) {
        if (j = "", k = 0, N = (S = e).charAt(0), O = "", I = x, P(), e = I === f && "{" === O, F(), "" === O) return j;
        if (e && A()) {
          for (; A();) j = p(j, ","), F();
          return "[\n" + j + "\n]"
        }
    ...
    var i = function() {
      function t(e) {
        if (! function(e) {
          ...
          }(this), this.target = e.target || null, !this.target) throw new Error('FocusTracker constructor called without a "target" to track.');
      ...
      return e = t, (n = [{
        key: "destroy",
        value: function() {
          document.removeEventListener("click", this._onClick), document.removeEventListener("keyup", this._onKeyUp), this._onEvent({
    ...
    var o = function() {
      function h(e, t, n, i) {
        ...
        for (var o = {
          ...
          l.className = "jsoneditor-type-modes" + (n === a ? " jsoneditor-selected" : ""), r.push(l)
        }
        var c = o[n];
        if (!c) throw new Error('Unknown mode "' + n + '"');
        var c = c.text,
          d = document.createElement("button");
        d.type = "button", d.className = "jsoneditor-modes jsoneditor-separator", d.textContent = c + " ▾", d.title = Object(p.c)("modeEditorTitle"), d.onclick = function() {
          new u.a(r).show(d, e)
        };
        c = document.createElement("div");
        c.className = "jsoneditor-modes", c.style.position = "relative", c.appendChild(d), e.appendChild(c), this.dom = {
          container: e,
          box: d,
          frame: c
        }
    ...
    var d = {
      extend: function(e, t) {
        for (var n in t = t || {}, e) e.hasOwnProperty(n) && (t.hasOwnProperty(n) || (t[n] = e[n]));
        return t
      },
      each: function(e, t, n) {
      ...
      createElement: function(e, t) {
        ...
        if (t && "[object Object]" === Object.prototype.toString.call(t))
          for (n in t) n in r ? r[n] = t[n] : "html" === n ? r.textContent = t[n] : "text" === n ? (i = o.createTextNode(t[n]), r.appendChild(i)) : r.setAttribute(n, t[n]);
        return r
      },
      ...
      addClass: function(e, t) {
        d.hasClass(e, t) || (e.classList ? e.classList.add(t) : e.className = e.className.trim() + " " + t)
      },
      ...
      closest: function(e, t) {
        return e && e !== document.body && (t(e) ? e : d.closest(e.parentNode, t))
      },
      isInt: function(e) {
    ...
    function s(e, t, n) {
      e.parentNode ? e.parentNode.parentNode || t.appendChild(e.parentNode) : t.appendChild(e), d.removeClass(e, "excluded"), n || (e.textContent = e.textContent + "")
    }

    function a() {
      var n, e;
      this.items.length && (n = document.createDocumentFragment(), this.config.pagination ? (e = this.pages.slice(0, this.pageIndex), d.each(e, function(e, t) {
        d.each(t, function(e, t) {
          s(t, n, this.customOption)
        }, this)
      }, this)) : d.each(this.items, function(e, t) {
        s(t, n, this.customOption)
      }, this), n.childElementCount && (d.removeClass(this.items[this.navIndex], "active"), this.navIndex = n.querySelector(".selectr-option").idx, d.addClass(this.items[this.navIndex], "active")), this.tree.appendChild(n))
    }

    function c(e, t) {
      return t = t || e, t = this.customOption ? this.config.renderOption(t) : e.textContent, (t = d.createElement("li", {
        class: "selectr-option",
        html: t,
        role: "treeitem",
        "aria-selected": !1
      })).idx = e.idx, this.items.push(t), e.defaultSelected && this.defaultSelected.push(e.idx), e.disabled && (t.disabled = !0, d.addClass(t, "disabled")), t
    }

    function r() {
      (this.config.searchable || this.config.taggable) && (this.input.value = null, this.searching = !1, this.config.searchable && d.removeClass(this.inputContainer, "active"), d.hasClass(this.container, "notice") && (d.removeClass(this.container, "notice"), d.addClass(this.container, "open"), this.input.focus()), d.each(this.items, function(e, t) {
        d.removeClass(t, "excluded"), this.customOption || (t.textContent = t.textContent + "")
      }, this))
    }
    ...
    var u = function() {
      var n, e = this.tree,
        t = e.scrollTop;
      e.scrollHeight - e.offsetHeight <= t && this.pageIndex < this.pages.length && (n = document.createDocumentFragment(), d.each(this.pages[this.pageIndex], function(e, t) {
        s(t, n, this.customOption)
      }, this), e.appendChild(n), this.pageIndex++, this.emit("selectr.paginate", {
    ...
    h.prototype.render = function(e) {
      var t;
      this.rendered || (this.config = d.extend(o, e), this.originalType = this.el.type, this.originalIndex = this.el.tabIndex, this.defaultSelected = [], this.originalOptionCount = this.el.options.length, (this.config.multiple || this.config.taggable) && (this.el.multiple = !0), this.disabled = l(this.config, "disabled"), this.opened = !1, this.config.taggable && (this.config.searchable = !1), this.navigating = !1, this.mobileDevice = !1, /Android|webOS|iPhone|iPad|BlackBerry|Windows Phone|Opera Mini|IEMobile|Mobile/i.test(navigator.userAgent) && (this.mobileDevice = !0), this.customOption = this.config.hasOwnProperty("renderOption") && "function" == typeof this.config.renderOption, this.customSelected = this.config.hasOwnProperty("renderSelection") && "function" == typeof this.config.renderSelection, i.mixin(this), function() {
        this.requiresPagination = this.config.pagination && 0 < this.config.pagination, l(this.config, "width") && (d.isInt(this.config.width) ? this.width = this.config.width + "px" : "auto" === this.config.width ? this.width = "100%" : d.includes(this.config.width, "%") && (this.width = this.config.width)), this.container = d.createElement("div", {
          class: "selectr-container"
        }), this.config.customClass && d.addClass(this.container, this.config.customClass), this.mobileDevice ? d.addClass(this.container, "selectr-mobile") : d.addClass(this.container, "selectr-desktop"), this.el.tabIndex = -1, this.config.nativeDropdown || this.mobileDevice ? d.addClass(this.el, "selectr-visible") : d.addClass(this.el, "selectr-hidden"), this.selected = d.createElement("div", {
          class: "selectr-selected",
          disabled: this.disabled,
          tabIndex: 1,
          "aria-expanded": !1
        }), this.label = d.createElement(this.el.multiple ? "ul" : "span", {
          class: "selectr-label"
        });
        ...
        this.tree = d.createElement("ul", {
          ...
          class: "selectr-clear",
          type: "button"
        }), this.container.appendChild(this.selectClear), d.addClass(this.container, "clearable")), this.config.taggable && (e = d.createElement("li", {
          class: "input-tag"
          ...
          role: "textbox",
          type: "search"
        }), e.appendChild(this.input), this.label.appendChild(e), d.addClass(this.container, "taggable"), this.tagSeperators = [","], this.config.tagSeperators && (this.tagSeperators = this.tagSeperators.concat(this.config.tagSeperators))), this.config.searchable && (this.input = d.createElement("input", {
          class: "selectr-input",
          tagIndex: -1,
          autocomplete: "off",
          autocorrect: "off",
        ...
        }), this.inputContainer.appendChild(this.input), this.inputContainer.appendChild(this.inputClear), t.appendChild(this.inputContainer)), t.appendChild(this.notice), t.appendChild(this.tree), this.items = [], this.options = [], this.el.options.length && (this.options = [].slice.call(this.el.options));
        var n, i, o, r = !1,
          s = 0;
        this.el.children.length && d.each(this.el.children, function(e, t) {
          "OPTGROUP" === t.nodeName ? (r = d.createElement("ul", {
            class: "selectr-optgroup",
            role: "group",
            html: "<li class='selectr-optgroup--label'>" + t.label + "</li>"
          }), d.each(t.children, function(e, t) {
            t.idx = s, r.appendChild(c.call(this, t, r)), s++
          }, this)) : (t.idx = s, c.call(this, t), s++)
        }, this), this.config.data && Array.isArray(this.config.data) && (n = !(this.data = []), r = !1, s = 0, d.each(this.config.data, function(e, t) {
          l(t, "children") ? (n = d.createElement("optgroup", {
            label: t.text
            ...
            (i = new Option(t.text, t.value, !1, t.hasOwnProperty("selected") && !0 === t.selected)).disabled = l(t, "disabled"), this.options.push(i), n.appendChild(i), i.idx = s, r.appendChild(c.call(this, i, t)), this.data[s] = t, s++
          }, this)) : ((i = new Option(t.text, t.value, !1, t.hasOwnProperty("selected") && !0 === t.selected)).disabled = l(t, "disabled"), this.options.push(i), i.idx = s, c.call(this, i, t), this.data[s] = t, s++)
        ...
        for (var a = this.navIndex = 0; a < this.items.length; a++)
          if (o = this.items[a], !d.hasClass(o, "disabled")) {
            ...
            break
          } this.requiresPagination && (this.pageIndex = 1, this.paginate()), this.container.appendChild(this.selected), this.container.appendChild(t), this.placeEl = d.createElement("div", {
      ...
      }.call(this), this.bindEvents(), this.update(), this.optsRect = d.rect(this.tree), this.rendered = !0, this.el.multiple || (this.el.selectedIndex = this.selectedIndex), t = this, setTimeout(function() {
        t.emit("selectr.init")
      }, 20))
      ...
      this.events = {}, this.events.dismiss = function(e) {
        e = e.target;
        this.container.contains(e) || !this.opened && !d.hasClass(this.container, "notice") || this.close()
      }.bind(this), this.events.navigate = function(e) {
        if (e = e || window.event, this.items.length && this.opened && d.includes([13, 38, 40], e.which)) {
          ...
          for (this.navigating = !0; d.hasClass(this.items[this.navIndex], "disabled") || d.hasClass(this.items[this.navIndex], "excluded");)
        ...
        e.preventDefault(), e.stopPropagation(), e.target === i.el && i.toggle()
      }), this.el.addEventListener("change", function(e) {
        var t;
        i.el.multiple ? (t = i.getSelectedProperties("idx"), t = function(e, t) {
          for (var n, i = [], o = e.slice(0), r = 0; r < t.length; r++) - 1 < (n = o.indexOf(t[r])) ? o.splice(n, 1) : i.push(t[r]);
          return [i, o]
        }(i.selectedIndexes, t), d.each(t[0], function(e, t) {
          i.select(t)
        }, i), d.each(t[1], function(e, t) {
          i.deselect(t)
        }, i)) : -1 < i.el.selectedIndex && i.select(i.el.selectedIndex)
      })), this.config.nativeDropdown && this.container.addEventListener("keydown", function(e) {
        "Enter" === e.key && i.selected === document.activeElement && (i.toggle(), setTimeout(function() {
          i.el.focus()
        }, 200))
      }), this.selected.addEventListener("click", function(e) {
        i.disabled || i.toggle(), e.preventDefault(), e.stopPropagation()
      }), this.label.addEventListener("click", function(e) {
        d.hasClass(e.target, "selectr-tag-remove") && i.deselect(e.target.parentNode.idx)
        ...
        e && (d.hasClass(e, "disabled") || (d.hasClass(e, "selected") ? (i.el.multiple || !i.el.multiple && i.config.allowDeselect) && i.deselect(e.idx) : i.select(e.idx), i.opened && !i.el.multiple && i.close()))
      }), this.tree.addEventListener("mouseover", function(e) {
        d.hasClass(e.target, "selectr-option") && (d.hasClass(e.target, "disabled") || (d.removeClass(i.items[i.navIndex], "active"), d.addClass(e.target, "active"), i.navIndex = [].slice.call(i.items).indexOf(e.target)))
      }), this.config.searchable && (this.input.addEventListener("focus", function(e) {
        i.searching = !0
      }), this.input.addEventListener("blur", function(e) {
        i.searching = !1
      }), this.input.addEventListener("keyup", function(e) {
        i.search(), i.config.taggable || (this.value.length ? d.addClass(this.parentNode, "active") : d.removeClass(this.parentNode, "active"))
      }), this.inputClear.addEventListener("click", function(e) {
        i.input.value = null, r.call(i), i.tree.childElementCount || a.call(i)
      })), this.config.taggable && this.input.addEventListener("keyup", function(e) {
        var n;
        i.search(), i.config.taggable && this.value.length && (n = this.value.trim(), 13 !== e.which && !d.includes(i.tagSeperators, e.key) || (d.each(i.tagSeperators, function(e, t) {
          n = n.replace(t, "")
        }), i.add({
          value: n,
          text: n,
          selected: !0
        }, !0) ? (i.close(), r.call(i)) : (this.value = "", i.setMessage("That tag is already in use."))))
      }), this.update = d.debounce(function() {
        i.opened && i.config.closeOnScroll && i.close(), i.width && (i.container.style.width = i.width), i.invert()
      ...
      var n;
      this.config.data || this.el.multiple || !this.el.options.length || (0 === this.el.selectedIndex && (this.el.options[0].defaultSelected || this.config.defaultSelected || (this.el.selectedIndex = -1)), this.selectedIndex = this.el.selectedIndex, -1 < this.selectedIndex && this.select(this.selectedIndex)), this.config.multiple && "select-one" === this.originalType && !this.config.data && this.el.options[0].selected && !this.el.options[0].defaultSelected && (this.el.options[0].selected = !1), d.each(this.options, function(e, t) {
        t.selected && t.defaultSelected && this.select(t.idx)
      }, this), this.config.selectedValue && this.setValue(this.config.selectedValue), this.config.data && (!this.el.multiple && this.config.defaultSelected && this.el.selectedIndex < 0 && this.select(0), n = 0, d.each(this.config.data, function(e, t) {
        l(t, "children") ? d.each(t.children, function(e, t) {
          t.hasOwnProperty("selected") && !0 === t.selected && this.select(n), n++
        }, this) : (t.hasOwnProperty("selected") && !0 === t.selected && this.select(n), n++)
      }, this))
      ...
      var t = this.items[e],
        n = this.options[e];
      n.disabled || (n.selected && d.hasClass(t, "selected") ? this.deselect(e) : this.select(e), this.opened && !this.el.multiple && this.close())
      ...
      if (this.el.multiple) {
        ...
        this.selectedValues.push(n.value), this.selectedIndexes.push(i),
          function(e) {
            var l, c = this,
              n = document.createDocumentFragment(),
              t = this.options[e.idx],
              i = this.data ? this.data[e.idx] : t,
              o = this.customSelected ? this.config.renderSelection(i) : t.textContent,
            ...
            i.appendChild(o), i.idx = e.idx, i.tag = t.value, this.tags.push(i), this.config.sortSelected ? (t = this.tags.slice(), l = function(e, i) {
              ...
              var n, i, o = [],
                r = [];
              for (!0 === c.config.sortSelected ? (n = e.tag, i = t.tag) : "text" === c.config.sortSelected && (n = e.textContent, i = t.textContent), l(n, o), l(i, r); o.length && r.length;) {
                var s = o.shift(),
                  a = r.shift(),
              ...
              n.appendChild(t)
            }), this.label.textContent = "") : n.appendChild(i), this.config.taggable ? this.label.insertBefore(n, this.input.parentNode) : this.label.appendChild(n)
          }.call(this, e)
      } else {
        var o = this.data ? this.data[i] : n;
        this.label.textContent = this.customSelected ? this.config.renderSelection(o) : n.textContent, this.selectedValue = n.value, this.selectedIndex = i, d.each(this.options, function(e, t) {
          var n = this.items[e];
          e !== i && (n && d.removeClass(n, "selected"), t.selected = !1, t.removeAttribute("selected"))
        }, this)
      }
      d.includes(t, n) || this.el.add(n), e.setAttribute("aria-selected", !0), d.addClass(e, "selected"), d.addClass(this.container, "has-selected"), n.selected = !0, n.setAttribute("selected", ""), this.emit("selectr.change", n), this.emit("selectr.select", n)
        ...
        this.selectedValues.splice(o, 1),
          function(n) {
            ...
            d.each(this.tags, function(e, t) {
              t.idx === n.idx && (i = t)
            }, this), i && (this.label.removeChild(i), this.tags.splice(this.tags.indexOf(i), 1))
          }.call(this, n), this.tags.length || d.removeClass(this.container, "has-selected")
      } else {
        if (!t && !this.config.clearable && !this.config.allowDeselect) return !1;
        this.label.textContent = "", this.selectedValue = null, this.el.selectedIndex = this.selectedIndex = -1, d.removeClass(this.container, "has-selected")
      }
      this.items[e].setAttribute("aria-selected", !1), d.removeClass(this.items[e], "selected"), i.selected = !1, i.removeAttribute("selected"), this.emit("selectr.change", null), this.emit("selectr.deselect", i)
    }, h.prototype.setValue = function(n) {
      var i = Array.isArray(n);
      if (i || (n = n.toString().trim()), !this.el.multiple && i) return !1;
      d.each(this.options, function(e, t) {
        (i && d.includes(n.toString(), t.value) || t.value === n) && this.change(t.idx)
      }, this)
    }, h.prototype.getValue = function(e, t) {
      var n, i;
      return this.el.multiple ? e ? this.selectedIndexes.length && (i = {
        values: []
      }, d.each(this.selectedIndexes, function(e, t) {
        t = this.options[t];
        i.values[e] = {
          value: t.value,
          text: t.textContent
        }
      }, this)) : i = this.selectedValues.slice() : i = e ? {
        value: (n = this.options[this.selectedIndex]).value,
        text: n.textContent
      } : this.selectedValue, e && t && (i = JSON.stringify(i)), i
    }, h.prototype.add = function(n, i) {
      if (n) {
        if (this.data = this.data || [], this.items = this.items || [], this.options = this.options || [], Array.isArray(n)) d.each(n, function(e, t) {
          this.add(t, i)
        }, this);
        else if ("[object Object]" === Object.prototype.toString.call(n)) {
          if (i) {
            var o = !1;
            if (d.each(this.options, function(e, t) {
                t.value.toLowerCase() === n.value.toLowerCase() && (o = !0)
              }), o) return !1
          }
          var e = d.createElement("option", n);
          return this.data.push(n), this.options.push(e), e.idx = 0 < this.options.length ? this.options.length - 1 : 0, c.call(this, e), n.selected && this.select(e.idx), e
        }
        return this.setPlaceholder(), this.config.pagination && this.paginate(), !0
      }
    }, h.prototype.remove = function(n) {
      var i, o = [];
      Array.isArray(n) ? d.each(n, function(e, t) {
        d.isInt(t) ? o.push(this.getOptionByIndex(t)) : "string" == typeof n && o.push(this.getOptionByValue(t))
      }, this) : d.isInt(n) ? o.push(this.getOptionByIndex(n)) : "string" == typeof n && o.push(this.getOptionByValue(n)), o.length && (d.each(o, function(e, t) {
        i = t.idx, this.el.remove(t), this.options.splice(i, 1);
        t = this.items[i].parentNode;
        t && t.removeChild(this.items[i]), this.items.splice(i, 1), d.each(this.options, function(e, t) {
          t.idx = e, this.items[e].idx = e
        }, this)
      }, this), this.setPlaceholder(), this.config.pagination && this.paginate())
    }, h.prototype.removeAll = function() {
      this.clear(!0), d.each(this.el.options, function(e, t) {
        this.el.remove(t)
      }, this), d.truncate(this.tree), this.items = [], this.options = [], this.data = [], this.navIndex = 0, this.requiresPagination && (this.requiresPagination = !1, this.pageIndex = 1, this.pages = []), this.setPlaceholder()
    }, h.prototype.search = function(o) {
      var r, e, t;
      this.navigating || (o = o || this.input.value, r = document.createDocumentFragment(), this.removeMessage(), d.truncate(this.tree), 1 < o.length ? (d.each(this.options, function(e, t) {
        var n, i = this.items[t.idx];
        d.includes(t.textContent.toLowerCase(), o.toLowerCase()) && !t.disabled ? (s(i, r, this.customOption), d.removeClass(i, "excluded"), this.customOption || (i.textContent = "", (n = function(e, t) {
          ...
          return null
        }(o, t.textContent)) && (i.appendChild(document.createTextNode(n.before)), (t = document.createElement("span")).className = "selectr-match", t.appendChild(document.createTextNode(n.match)), i.appendChild(t), i.appendChild(document.createTextNode(n.after))))) : d.addClass(i, "excluded")
      }, this), r.childElementCount ? (e = this.items[this.navIndex], t = r.firstElementChild, d.removeClass(e, "active"), this.navIndex = t.idx, d.addClass(t, "active")) : this.config.taggable || this.setMessage("no results.")) : a.call(this), this.tree.appendChild(r))
    }, h.prototype.toggle = function() {
      this.disabled || (this.opened ? this.close() : this.open())
    }, h.prototype.open = function() {
      var e = this;
      return !!this.options.length && (this.opened || this.emit("selectr.open"), this.opened = !0, this.mobileDevice || this.config.nativeDropdown ? (d.addClass(this.container, "native-open"), void(this.config.data && d.each(this.options, function(e, t) {
        this.el.add(t)
      }, this))) : (d.addClass(this.container, "open"), a.call(this), this.invert(), this.tree.scrollTop = 0, d.removeClass(this.container, "notice"), this.selected.setAttribute("aria-expanded", !0), this.tree.setAttribute("aria-hidden", !1), this.tree.setAttribute("aria-expanded", !0), void(this.config.searchable && !this.config.taggable && setTimeout(function() {
        e.input.focus(), e.input.tabIndex = 0
      }, 10))))
    }, h.prototype.close = function() {
      var e;
      this.opened && this.emit("selectr.close"), this.opened = !1, this.mobileDevice || this.config.nativeDropdown ? d.removeClass(this.container, "native-open") : (e = d.hasClass(this.container, "notice"), this.config.searchable && !e && (this.input.blur(), this.input.tabIndex = -1, this.searching = !1), e && (d.removeClass(this.container, "notice"), this.notice.textContent = ""), d.removeClass(this.container, "open"), d.removeClass(this.container, "native-open"), this.selected.setAttribute("aria-expanded", !1), this.tree.setAttribute("aria-hidden", !0), this.tree.setAttribute("aria-expanded", !1), d.truncate(this.tree), r.call(this))
    }, h.prototype.enable = function() {
      this.disabled = !1, this.el.disabled = !1, this.selected.tabIndex = this.originalIndex, this.el.multiple && d.each(this.tags, function(e, t) {
        t.lastElementChild.tabIndex = 0
      }), d.removeClass(this.container, "selectr-disabled")
    }, h.prototype.disable = function(e) {
      e || (this.el.disabled = !0), this.selected.tabIndex = -1, this.el.multiple && d.each(this.tags, function(e, t) {
        t.lastElementChild.tabIndex = -1
      }), this.disabled = !0, d.addClass(this.container, "selectr-disabled")
    }, h.prototype.reset = function() {
      this.disabled || (this.clear(), this.setSelected(!0), d.each(this.defaultSelected, function(e, t) {
        this.select(t)
      }, this), this.emit("selectr.reset"))
    }, h.prototype.clear = function(e) {
      var t;
      this.el.multiple ? this.selectedIndexes.length && (t = this.selectedIndexes.slice(), d.each(t, function(e, t) {
        this.deselect(t)
      }, this)) : -1 < this.selectedIndex && this.deselect(this.selectedIndex, e), this.emit("selectr.clear")
    }, h.prototype.serialise = function(e) {
      var i = [];
      return d.each(this.options, function(e, t) {
        var n = {
          value: t.value,
          text: t.textContent
        };
        t.selected && (n.selected = !0), t.disabled && (n.disabled = !0), i[e] = n
      ...
      if (this.items.length) {
        ...
        return this.pages = this.items.map(function(e, t) {
          return t % n.config.pagination == 0 ? n.items.slice(t, t + n.config.pagination) : null
        }).filter(function(e) {
          return e
        }), this.pages
      }
    }, h.prototype.setMessage = function(e, t) {
      t && this.close(), d.addClass(this.container, "notice"), this.notice.textContent = e
    }, h.prototype.removeMessage = function() {
      d.removeClass(this.container, "notice"), this.notice.textContent = ""
    }, h.prototype.invert = function() {
      var e = d.rect(this.selected),
        t = this.tree.parentNode.offsetHeight,
        n = window.innerHeight;
      e.top + e.height + t > n ? (d.addClass(this.container, "inverted"), this.isInverted = !0) : (d.removeClass(this.container, "inverted"), this.isInverted = !1), this.optsRect = d.rect(this.tree)
    ...
    function i(i, e, o) {
      var t, n = 3 < arguments.length && void 0 !== arguments[3] && arguments[3],
        r = "function" == typeof(l = i).getRootNode ? l.getRootNode() : window,
        s = {},
      ...
      function d() {
        if (c && c.parentNode) {
          for (var e in c.parentNode.removeChild(c), s) t = s, n = e, Object.prototype.hasOwnProperty.call(t, n) && ((n = s[e]) && Object(u.removeEventListener)(r, e, n), delete s[e]);
    ...
    e.exports = function t(e, n) {
      ...
      var o, r, s = /(^([+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?)?$|^0x[0-9a-f]+$|\d+)/gi,
        a = /(^[ ]*|[ ]*$)/g,
        ...
        e = i(e).replace(a, "") || "",
        a = i(n).replace(a, "") || "",
        h = e.replace(s, "\0$1\0").replace(/\0$/, "").replace(/^\0/, "").split("\0"),
        u = a.replace(s, "\0$1\0").replace(/\0$/, "").replace(/^\0/, "").split("\0"),
        e = parseInt(e.match(c), 16) || 1 !== h.length && e.match(l) && Date.parse(e),
      ...
      for (var p = 0, f = Math.max(h.length, u.length); p < f; p++) {
        if (o = !(h[p] || "").match(d) && parseFloat(h[p]) || h[p] || 0, r = !(u[p] || "").match(d) && parseFloat(u[p]) || u[p] || 0, isNaN(o) !== isNaN(r)) return isNaN(o) ? 1 : -1;
    ...
    ! function() {
      "use strict";
      i = [], void 0 === (o = "function" == typeof(o = function() {
        "use strict";

        function S(e) {
          if (typeof Node === "object") return e instanceof Node;
          else return e && typeof e === "object" && typeof e.nodeType === "number"
        }
        ...
        function t(e, t) {
          return N.make((i = a)("parent")).clazz("pico-overlay").clazz(i("overlayClass", "")).stylize({
            display: "none",
            position: "fixed",
            top: "0px",
            left: "0px",
        ...
        function n(e, t) {
          ...
          return N.make(e("parent")).clazz("pico-content").clazz(e("modalClass", "")).stylize({
            display: "none",
            position: "fixed",
            zIndex: 10001,
            left: "50%",
        ...
        function o(e, t) {
          ...
          function T(e) {
            return !(k(e) || _(e, ":disabled") || e.hasAttribute("contenteditable")) && (e.hasAttribute("tabindex") || _(e, "input,select,textarea,button,a[href],area[href],iframe"))
          }
          ...
          d.beforeShow(function() {
            ...
            var t, n;
            h() && d.isVisible() && (t = w(d.modalElem()), n = function(e) {
              for (var t = e.getElementsByTagName("*"), n = t.length; n--;)
                if (T(t[n])) return t[n]
            }(d.modalElem()), (e.shiftKey ? t : n) === document.activeElement && ((e.shiftKey ? n : t).focus(), e.preventDefault()))
          })
        }

        function r(e, t) {
          var f, m = new N(document.body);
          u.beforeShow(function() {
            f = m.elem.style.overflow, p() && m.stylize({
              overflow: "hidden"
            })
        ...
        return document.documentElement.addEventListener("keydown", function(e) {
          ...
          function(n) {
            ...
            function a(e, t) {
              e = n[e];
              return "function" == typeof e && (e = e(t)), void 0 === e ? t : e
            }
            var l, c, d, h, e, u, p, f, m, g = E.bind(window, "modal"),
            ...
            function E(e, t) {
              ...
              return c || (n = function(e, t) {
                ...
                modal: n,
                overlay: (o = x, N.make((i = a)("parent")).clazz("pico-overlay").clazz(i("overlayClass", "")).stylize({
                  display: "none",
                  position: "fixed",
                  top: "0px",
                  left: "0px",
            ...
            return l = {
              ...
              show: function(e) {
                return t.trigger(l, e) && (v().show(), y(), g().show(), i.trigger(l, e)), this
              },
              close: C(x),
              forceClose: C(b),
              destroy: function() {
            ...
            }, d = l, h = a.bind(null, "focus", !0), d.beforeShow(function() {
              e = document.activeElement
            }), d.afterShow(function() {
              var e;
              !h() || (e = w(d.modalElem())) && e.focus()
            ...
            }), u = l, p = a.bind(null, "bodyOverflow", !0), m = new N(document.body), u.beforeShow(function() {
              f = m.elem.style.overflow, p() && m.stylize({
                overflow: "hidden"
              })
            }), u.afterClose(function() {
    ...
    var i = function() {
      function n(e) {
        ...
        }(this), this.errorTableVisible = e.errorTableVisible, this.onToggleVisibility = e.onToggleVisibility, this.onFocusLine = e.onFocusLine || function() {}, this.onChangeHeight = e.onChangeHeight, this.dom = {};
        var t = document.createElement("div");
      ...
      return e = n, (t = [{
        ...
        value: function(e, a) {
          var t, l, c = this;
          this.dom.validationErrors && (this.dom.validationErrors.parentNode.removeChild(this.dom.validationErrors), this.dom.validationErrors = null, this.dom.additionalErrorsIndication.style.display = "none"), this.errorTableVisible && 0 < e.length ? ((n = document.createElement("div")).className = "jsoneditor-validation-errors", (t = document.createElement("table")).className = "jsoneditor-text-errors", n.appendChild(t), l = document.createElement("tbody"), t.appendChild(l), e.forEach(function(t) {
            var e;
            isNaN(t.line) ? !t.dataPath || (o = a.find(function(e) {
              return e.path === t.dataPath
            })) && (e = o.line + 1) : e = t.line;
            var n = document.createElement("tr");
            n.className = isNaN(e) ? "" : "jump-to-line", "error" === t.type ? n.className += " parse-error" : n.className += " validation-error";
            var i = document.createElement("td"),
              o = document.createElement("button");
            o.className = "jsoneditor-schema-error", i.appendChild(o), n.appendChild(i);
            var r, s, i = document.createElement("td");
            i.style = "white-space: nowrap;", i.textContent = isNaN(e) ? "" : "Ln " + e, n.appendChild(i), "string" == typeof t ? ((r = document.createElement("td")).colSpan = 2, (s = document.createElement("pre")).appendChild(document.createTextNode(t)), r.appendChild(s), n.appendChild(r)) : ((s = document.createElement("td")).appendChild(document.createTextNode(t.dataPath || "")), n.appendChild(s), r = document.createElement("td"), (s = document.createElement("pre")).appendChild(document.createTextNode(t.message)), r.appendChild(s), n.appendChild(r)), n.onclick = function() {
              c.onFocusLine(e)
            }, l.appendChild(n)
          }), this.dom.validationErrors = n, this.dom.validationErrorsContainer.appendChild(n), this.dom.additionalErrorsIndication.title = e.length + " errors total", this.dom.validationErrorsContainer.clientHeight < this.dom.validationErrorsContainer.scrollHeight ? (this.dom.additionalErrorsIndication.style.display = "block", this.dom.validationErrorsContainer.onscroll = function() {
    ...
    "use strict";
    n.r(t), n.d(t, "textModeMixins", function() {
      return l
    });
    var t = n(7),
      i = n.n(t),
    ...
    n.create = function(e) {
      ...
      void 0 === n.statusBar && (n.statusBar = !0), n.mainMenuBar = !1 !== n.mainMenuBar, n.enableSort = !1 !== n.enableSort, n.enableTransform = !1 !== n.enableTransform, n.createQuery = n.createQuery || m.a, n.executeQuery = n.executeQuery || m.b, "number" == typeof(this.options = n).indentation ? this.indentation = Number(n.indentation) : this.indentation = 2, Object(f.b)(this.options.languages), Object(f.a)(this.options.language);
      var i = n.ace || h.a;
      this.mode = "code" === n.mode ? "code" : "text", "code" === this.mode && void 0 === i && (this.mode = "text", console.warn("Failed to load Ace editor, falling back to plain text mode. Please use a JSONEditor bundle including Ace, or pass Ace as via the configuration option `ace`.")), this.theme = n.theme || x, this.theme === x && i && Object(v.tryRequireThemeJsonEditor)(), n.onTextSelectionChange && this.onTextSelectionChange(n.onTextSelectionChange);
      var o = this;
      ...
      this.frameFocusTracker = new p.a(e), this.content = document.createElement("div"), this.content.className = "jsoneditor-outer", this.options.mainMenuBar && (Object(y.addClassName)(this.content, "has-main-menu-bar"), this.menu = document.createElement("div"), this.menu.className = "jsoneditor-menu", this.frame.appendChild(this.menu), (e = document.createElement("button")).type = "button", e.className = "jsoneditor-format", e.title = Object(f.c)("formatTitle"), this.menu.appendChild(e), e.onclick = function() {
        try {
          o.format(), o._onChange()
        } catch (e) {
          o._onError(e)
        }
      }, (e = document.createElement("button")).type = "button", e.className = "jsoneditor-compact", e.title = Object(f.c)("compactTitle"), this.menu.appendChild(e), e.onclick = function() {
        try {
          o.compact(), o._onChange()
        } catch (e) {
          o._onError(e)
        }
      }, this.options.enableSort && ((e = document.createElement("button")).type = "button", e.className = "jsoneditor-sort", e.title = Object(f.c)("sortTitleShort"), e.onclick = function() {
        o._showSortModal()
      }, this.menu.appendChild(e)), this.options.enableTransform && ((r = document.createElement("button")).type = "button", r.title = Object(f.c)("transformTitleShort"), r.className = "jsoneditor-transform", r.onclick = function() {
        o._showTransformModal()
      }, this.menu.appendChild(r)), (r = document.createElement("button")).type = "button", r.className = "jsoneditor-repair", r.title = Object(f.c)("repairTitle"), this.menu.appendChild(r), r.onclick = function() {
        try {
          o.repair(), o._onChange()
        } catch (e) {
          o._onError(e)
        }
      }, "code" === this.mode && ((d = document.createElement("button")).type = "button", d.className = "jsoneditor-undo jsoneditor-separator", d.title = Object(f.c)("undo"), d.onclick = function() {
        t.aceEditor.getSession().getUndoManager().undo()
      }, this.menu.appendChild(d), this.dom.undo = d, (d = document.createElement("button")).type = "button", d.className = "jsoneditor-redo", d.title = Object(f.c)("redo"), d.onclick = function() {
        t.aceEditor.getSession().getUndoManager().redo()
      }, this.menu.appendChild(d), this.dom.redo = d), this.options && this.options.modes && this.options.modes.length && (this.modeSwitcher = new g.a(this.menu, this.options.modes, this.options.mode, function(e) {
        o.setMode(e), o.modeSwitcher.focus()
      })), "code" === this.mode && ((s = document.createElement("a")).appendChild(document.createTextNode("powered by ace")), s.href = "https://ace.c9.io/", s.target = "_blank", s.className = "jsoneditor-poweredBy", s.onclick = function() {
        window.open(s.href, s.target, "noopener")
      }, this.menu.appendChild(s)));
      var a, l, c, d = this.options.onEditable && b("function" === this.options.onEditable) && !this.options.onEditable({});
      this.frame.appendChild(this.content), this.container.appendChild(this.frame), "code" === this.mode ? (this.editorDom = document.createElement("div"), this.editorDom.style.height = "100%", this.editorDom.style.width = "100%", this.content.appendChild(this.editorDom), i = (l = i.edit(this.editorDom)).getSession(), l.$blockScrolling = 1 / 0, l.setTheme(this.theme), l.setOptions({
        readOnly: d
      }), l.setShowPrintMargin(!1), l.setFontSize("13px"), i.setMode("ace/mode/json"), i.setTabSize(this.indentation), i.setUseSoftTabs(!0), i.setUseWrapMode(!0), a = i.setAnnotations, i.setAnnotations = function(e) {
        a.call(this, e && e.length ? e : o.annotations)
      }, l.commands.bindKey("Ctrl-L", null), l.commands.bindKey("Command-L", null), l.commands.bindKey("Ctrl-\\", null), l.commands.bindKey("Command-\\", null), l.commands.bindKey("Ctrl-Shift-\\", null), l.commands.bindKey("Command-Shift-\\", null), (this.aceEditor = l).on("change", this._onChange.bind(this)), l.on("changeSelection", this._onSelect.bind(this))) : ((c = document.createElement("textarea")).className = "jsoneditor-text", c.spellcheck = !1, this.content.appendChild(c), this.textarea = c, this.textarea.readOnly = d, null === this.textarea.oninput ? this.textarea.oninput = this._onChange.bind(this) : this.textarea.onchange = this._onChange.bind(this), c.onselect = this._onSelect.bind(this), c.onmousedown = this._onMouseDown.bind(this), c.onblur = this._onBlur.bind(this)), this._updateHistoryButtons(), this.errorTable = new u.a({
        errorTableVisible: "text" === this.mode,
        onToggleVisibility: function() {
          o.validate()
        },
        onFocusLine: function(e) {
          o.isFocused = !0, isNaN(e) || o.setTextSelection({
            row: e,
            column: 1
          }, {
            row: e,
      ...
      var n = this,
        ...
        i = this.get();
      Object(o.showSortModal)(e, i, function(e) {
        var t;
        Array.isArray(i) && (t = Object(y.sort)(i, e.path, e.direction), n.sortedBy = e, n.update(t)), Object(y.isObject)(i) && (t = Object(y.sortObjectKeys)(i, e.direction), n.sortedBy = e, n.update(t))
      }, n.sortedBy)
      ...
      var t = !1;
      220 === (e.which || e.keyCode) && e.ctrlKey && (e.shiftKey ? this.compact() : this.format(), this._onChange(), t = !0), t && (e.preventDefault(), e.stopPropagation()), this._updateCursorInfo(), this._emitSelectionChange()
      ...
      this.textarea ? setTimeout(function() {
        ...
        e.startIndex !== e.endIndex && (o = e.endIndex - e.startIndex), i = o && r.cursorInfo && r.cursorInfo.line === e.end.row && r.cursorInfo.column === e.end.column ? (n = e.start.row, e.start.column) : (n = e.end.row, e.end.column), r.cursorInfo = {
          line: n,
          column: i,
          count: o
      ...
      var n, i = this,
        e = !0 === this.options.escapeUnicode ? Object(y.escapeUnicodeChars)(e) : e;
      ...
      try {
        var e = this.get();
        this.validateSchema && (this.validateSchema(e) || (o = this.validateSchema.errors.map(function(e) {
          return e.type = "validation", Object(y.improveSchemaError)(e)
        ...
        (function(e, t) {
          ...
          try {
            var n = t(e);
            return (Object(y.isPromise)(n) ? n : Promise.resolve(n)).then(function(e) {
        ...
        })(e, this.options.onValidate).then(function(e) {
          a === s.validationSequence && (e = o.concat(r).concat(e), s._renderErrors(e), "function" == typeof i.options.onValidationError && (Object(y.isValidationErrorChanged)(e, i.lastSchemaErrors) && i.options.onValidationError.call(i, e), i.lastSchemaErrors = e))
        }).catch(function(e) {
          console.error("Custom validation function did throw an error", e)
        })
      } catch (e) {
        this.getText() && ((t = /\w*line\s*(\d+)\w*/g.exec(e.message)) && (n = +t[1]), r = [{
          type: "error",
          message: e.message.replace(/\n/g, "<br>"),
          line: n
        }]), this._renderErrors(r), "function" == typeof this.options.onValidationError && (Object(y.isValidationErrorChanged)(r, this.lastSchemaErrors) && this.options.onValidationError.call(this, r), this.lastSchemaErrors = r)
      }
      ...
      }), this._refreshAnnotations()), this.errorTable.setErrors(i, t), this.aceEditor && this.aceEditor.resize(!1)
      ...
      if (this.aceEditor) {
        ...
        return n.row === t.end.row && n.column === t.end.column ? e = t : (e.start = t.end, e.end = t.start), {
          start: {
            row: e.start.row + 1,
      ...
      "function" == typeof e && (this._selectionChangedHandler = Object(y.debounce)(e, this.DEBOUNCE_INTERVAL))
    }, n.setTextSelection = function(e, t) {
      var n, i, o;
      e && t && (this.textarea ? (n = Object(y.getIndexForPosition)(this.textarea, e.row, e.column), i = Object(y.getIndexForPosition)(this.textarea, t.row, t.column), -1 < n && -1 < i && (this.textarea.setSelectionRange ? (this.textarea.focus(), this.textarea.setSelectionRange(n, i)) : this.textarea.createTextRange && ((o = this.textarea.createTextRange()).collapse(!0), o.moveEnd("character", i), o.moveStart("character", n), o.select()), o = (this.textarea.value.match(/\n/g) || []).length + 1, o = this.textarea.scrollHeight / o, o = e.row * o, this.textarea.scrollTop = o > this.textarea.clientHeight ? o - this.textarea.clientHeight / 2 : 0)) : this.aceEditor && (t = {
        start: {
          row: e.row - 1,
          column: e.column - 1
        },
    ...
    var i, i = ((i = {
      ...
      parse: function(e) {
        ...
        for (var u, p, f, m, g, v, y, b, x, C = {};;) {
          if (f = n[n.length - 1], void 0 === (m = this.defaultActions[f] || (null == u && (u = h()), r[f] && r[f][u])) || !m.length || !m[0]) {
            if (!c) {
              for (v in b = [], r[f]) this.terminals_[v] && 2 < v && b.push("'" + this.terminals_[v] + "'");
              var E = "",
                E = this.lexer.showPosition ? "Parse error on line " + (a + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + b.join(", ") + ", got '" + this.terminals_[u] + "'" : "Parse error on line " + (a + 1) + ": Unexpected " + (1 == u ? "end of input" : "'" + (this.terminals_[u] || u) + "'");
              this.parseError(E, {
            ...
            if (3 == c) {
              ...
              l = this.lexer.yyleng, s = this.lexer.yytext, a = this.lexer.yylineno, d = this.lexer.yylloc, u = h()
            }
            for (; !(2..toString() in r[f]);) {
              if (0 == f) throw new Error(E || "Parsing halted.");
              x = 1, n.length = n.length - 2 * x, i.length = i.length - x, o.length = o.length - x, f = n[n.length - 1]
            }
            p = u, u = 2, m = r[f = n[n.length - 1]] && r[f][2], c = 3
          }
          if (m[0] instanceof Array && 1 < m.length) throw new Error("Parse Error: multiple actions possible at state: " + f + ", token: " + u);
          switch (m[0]) {
            case 1:
              n.push(u), i.push(this.lexer.yytext), o.push(this.lexer.yylloc), n.push(m[1]), u = null, p ? (u = p, p = null) : (l = this.lexer.yyleng, s = this.lexer.yytext, a = this.lexer.yylineno, d = this.lexer.yylloc, 0 < c && c--);
              break;
            case 2:
              if (y = this.productions_[m[1]][1], C.$ = i[i.length - y], C._$ = {
                  first_line: o[o.length - (y || 1)].first_line,
                  last_line: o[o.length - 1].last_line,
                  first_column: o[o.length - (y || 1)].first_column,
                  last_column: o[o.length - 1].last_column
                }, void 0 !== (g = this.performAction.call(C, s, l, a, this.yy, m[1], i, o))) return g;
              y && (n = n.slice(0, -1 * y * 2), i = i.slice(0, -1 * y), o = o.slice(0, -1 * y)), n.push(this.productions_[m[1]][0]), i.push(C.$), o.push(C._$), y = r[n[n.length - 2]][n[n.length - 1]], n.push(y);
              break;
            case 3:
              return !0
          }
      ...
      next: function() {
        ...
        for (var o = this._currentRules(), r = 0; r < o.length && (!(t = this._input.match(this.rules[o[r]])) || e && !(t[0].length > e[0].length) || (e = t, n = r, this.options.flex)); r++);
    ...
    "undefined" != typeof Element && (void 0 !== window.Element && n(window.Element.prototype), void 0 !== window.CharacterData && n(window.CharacterData.prototype), void 0 !== window.DocumentType && n(window.DocumentType.prototype)), Array.prototype.findIndex || Object.defineProperty(Array.prototype, "findIndex", {
      value: function(e) {
    ...
    t.parse = function(o, e, t) {
          ...
          case "{":
            n = function(e) {
              ...
              for (;;) {
                ...
                var i = d(),
                  o = e + "/" + _(i);
                g(o, "key", n), m(o, "keyEnd"), c(), ":" != u() && b(), c(), t[i] = l(o), c();
                o = u();
                if ("}" == o) break;
                "," != o && b(), c()
              }
            ...
            break;
          default:
            p(), 0 <= "-0123456789".indexOf(i) ? n = function() {
              var e = "",
                t = !0;
              "-" == o[s] && (e += u());
              e += ("0" == o[s] ? u : f)(), "." == o[s] && (e += u() + f(), t = !1);
              "e" != o[s] && "E" != o[s] || (e += u(), "+" != o[s] && "-" != o[s] || (e += u()), e += f(), t = !1);
              var n = +e;
      ...
      function d() {
        for (var e, t = "";
          '"' != (e = u());) "\\" == e ? (e = u()) in C ? t += C[e] : "u" == e ? t += function() {
          var e = 4,
            t = 0;
          for (; e--;) {
            t <<= 4;
            var n = u().toLowerCase();
            "a" <= n && n <= "f" ? t += n.charCodeAt() - E + 10 : "0" <= n && n <= "9" ? t += +n : b()
          }
        ...
        return function l(c, d, h) {
          ...
          switch (typeof c) {
            ...
            case "string":
              ...
              break;
            case "object":
              null === c ? m("null") : "function" == typeof c.toJSON ? m(x(c.toJSON())) : Array.isArray(c) ? e() : f ? c.constructor.BYTES_PER_ELEMENT ? e() : c instanceof Map ? n() : c instanceof Set ? n(!0) : t() : t()
          }
          v(h, "valueEnd");
          ...
          function t() {
            ...
            if (e.length) {
              ...
              for (var t = d + 1, n = 0; n < e.length; n++) {
                var i, o = e[n],
                  r = c[o];
                b(r) && (n && m(","), i = h + "/" + _(o), g(t), v(i, "key"), m(x(o)), v(i, "keyEnd"), m(":"), u && m(" "), l(r, t, i))
              }
              g(d), m("}")
            } else m("{}")
          }
          ...
          function n(e) {
            if (c.size) {
              m("{");
              for (var t = d + 1, n = !0, i = c.entries(), o = i.next(); !o.done;) {
                var r = o.value,
                  s = r[0],
                  a = !!e || r[1];
                b(a) && (n || m(","), n = !1, r = h + "/" + _(s), g(t), v(r, "key"), m(x(s)), v(r, "keyEnd"), m(":"), u && m(" "), l(a, t, r)), o = i.next()
              }
              g(d), m("}")
            } else m("{}")
          }
      ...
      function g(e) {
        if (u) {
          for (l += "\n" + y(e, u), d++, h = 0; e--;) i ? (d += i, h = s) : h += s, p += r;
          p += 1
        }
      }
    ...
    function x(e) {
      return '"' + (e = e.replace(o, "\\$&").replace(s, "\\f").replace(r, "\\b").replace(a, "\\n").replace(l, "\\r").replace(c, "\\t")) + '"'
    }
    var d = /~/g,
      h = /\//g;
    ...
    ! function(e) {
      ...
      L.prototype = {
        tokenize: function(e) {
          ...
          for (this._current = 0; this._current < e.length;)
            if ("a" <= (o = e[this._current]) && o <= "z" || "A" <= o && o <= "Z" || "_" === o) t = this._current, n = this._consumeUnquotedIdentifier(e), r.push({
              type: h,
              value: n,
              start: t
            });
            else if (void 0 !== F[e[this._current]]) r.push({
            type: F[e[this._current]],
            value: e[this._current],
            start: this._current
          }), this._current++;
          else if (B(e[this._current])) i = this._consumeNumber(e), r.push(i);
          else if ("[" === e[this._current]) i = this._consumeLBracket(e), r.push(i);
          else if ('"' === e[this._current]) t = this._current, n = this._consumeQuotedIdentifier(e), r.push({
            type: u,
            value: n,
            start: t
          });
          else if ("'" === e[this._current]) t = this._current, n = this._consumeRawStringLiteral(e), r.push({
            type: P,
            value: n,
            start: t
          });
          ...
          } else if (void 0 !== M[e[this._current]]) r.push(this._consumeOperator(e));
          else if (void 0 !== V[e[this._current]]) this._current++;
          else if ("&" === e[this._current]) t = this._current, this._current++, "&" === e[this._current] ? (this._current++, r.push({
            type: "And",
            value: "&&",
            start: t
          })) : r.push({
            ...
            t = this._current, this._current++, "|" === e[this._current] ? (this._current++, r.push({
              type: "Or",
              value: "||",
              start: t
            })) : r.push({
        ...
        _consumeNumber: function(e) {
          var t = this._current;
          this._current++;
          for (var n = e.length; B(e[this._current]) && this._current < n;) this._current++;
        ...
        _consumeLiteral: function(e) {
          this._current++;
          for (var t = this._current, n = e.length;
            "`" !== e[this._current] && this._current < n;) {
            var i = this._current;
            "\\" !== e[i] || "\\" !== e[i + 1] && "`" !== e[i + 1] ? i++ : i += 2, this._current = i
          }
      ...
      R.EOF = 0, R[h] = 0, R[u] = 0, R[p] = 0, R[f] = 0, R[m] = 0, R[i] = 0, R[v] = 0, R[j] = 0, R[k] = 0, R[N] = 1, R.Or = 2, R.And = 3, R.EQ = 5, R.GT = 5, R.LT = 5, R.GTE = 5, R.LTE = 5, R.NE = 5, R[D] = 9, R[y] = 20, R[b] = 21, R.Dot = 40, R.Not = 45, R[C] = 50, R[E] = 55, R[A] = 60, z.prototype = {
        parse: function(e) {
        ...
        expression: function(e) {
          ...
          this._advance();
          for (var n = this.nud(t), i = this._lookahead(0); e < R[i];) this._advance(), n = this.led(i, n), i = this._lookahead(0);
          return n
        },
        ...
        nud: function(e) {
          ...
          switch (e.type) {
            ...
            case u:
              ...
              if (this._lookahead(0) === A) throw new Error("Quoted identifier not allowed for function names.");
              return i;
            case "Not":
              return {
                type: "NotExpression", children: [t = this.expression(R.Not)]
              };
            case y:
              return t = null, {
            ...
            case E:
              return this._lookahead(0) === v || this._lookahead(0) === g ? (t = this._parseIndexExpression(), this._projectIfSlice({
                type: "Identity"
              }, t)) : this._lookahead(0) === y && this._lookahead(1) === p ? (this._advance(), this._advance(), {
                type: "Projection",
                children: [{
                  type: "Identity"
            ...
            case k:
              return {
                type: "ExpressionReference", children: [n = this.expression(R.Expref)]
              };
            case A:
              for (var o = []; this._lookahead(0) !== f;) this._lookahead(0) === j ? (n = {
                type: j
        ...
        led: function(e, t) {
          ...
          switch (e) {
            ...
            case N:
              return n = this.expression(R.Pipe), {
                type: N,
                children: [t, n]
              };
            case "Or":
              return {
                type: "OrExpression", children: [t, n = this.expression(R.Or)]
              };
            case "And":
              return {
                type: "AndExpression", children: [t, n = this.expression(R.And)]
              };
            case A:
              for (var o, i = t.name, r = []; this._lookahead(0) !== f;) this._lookahead(0) === j ? (o = {
                type: j
              }, this._advance()) : o = this.expression(0), this._lookahead(0) === m && this._match(m), r.push(o);
            ...
            case b:
              ...
              return this._match(p), {
                type: "FilterProjection",
                children: [t, n = this._lookahead(0) === D ? {
                  type: "Identity"
                } : this._parseProjectionRHS(R.Filter), s]
              };
            case D:
              return {
                type: "Projection", children: [{
            ...
            case E:
              ...
              return s.type === v || s.type === g ? (n = this._parseIndexExpression(), this._projectIfSlice(t, n)) : (this._match(y), this._match(p), {
                type: "Projection",
        ...
        _parseSliceExpression: function() {
          for (var e = [null, null, null], t = 0, n = this._lookahead(0); n !== p && t < 3;) {
            if (n === g) t++, this._advance();
            else {
              if (n !== v) {
                var i = this._lookahead(0),
                  i = new Error("Syntax error, unexpected token: " + i.value + "(" + i.type + ")");
        ...
        _parseDotRHS: function(e) {
          ...
          return 0 <= [h, u, y].indexOf(t) ? this.expression(e) : t === E ? (this._match(E), this._parseMultiselectList()) : t === C ? (this._match(C), this._parseMultiselectHash()) : void 0
        },
          ...
          if (R[this._lookahead(0)] < 10) t = {
            ...
            if (this._lookahead(0) !== x) {
              var n = this._lookaheadToken(0),
                n = new Error("Sytanx error, unexpected token: " + n.value + "(" + n.type + ")");
        ...
        _parseMultiselectList: function() {
          for (var e = []; this._lookahead(0) !== p;) {
            ...
            if (e.push(t), this._lookahead(0) === m && (this._match(m), this._lookahead(0) === p)) throw new Error("Unexpected token Rbracket")
          }
          return this._match(p), {
        ...
        _parseMultiselectHash: function() {
          for (var e, t = [], n = [h, u];;) {
            if (e = this._lookaheadToken(0), n.indexOf(e.type) < 0) throw new Error("Expecting an identifier token, got: " + e.type);
            if (e = e.value, this._advance(), this._match(g), e = {
                type: "KeyValuePair",
                name: e,
                value: this.expression(0)
              }, t.push(e), this._lookahead(0) === m) this._match(m);
        ...
        visit: function(e, t) {
          ...
          switch (e.type) {
            case "Field":
              return null === t || !T(t) || void 0 === (a = t[e.name]) ? null : a;
            case "Subexpression":
              for (d = this.visit(e.children[0], t), p = 1; p < e.children.length; p++)
                if (null === (d = this.visit(e.children[1], d))) return null;
              return d;
            case "IndexExpression":
              return E = this.visit(e.children[0], t), this.visit(e.children[1], E);
            case "Index":
              if (!_(t)) return null;
              var s = e.value;
              return s < 0 && (s = t.length + s), void 0 === (d = t[s]) && (d = null), d;
            case "Slice":
              if (!_(t)) return null;
              var a = e.children.slice(0),
                ...
                d = [];
              if (0 < c)
                for (p = a; p < l; p += c) d.push(t[p]);
              else
                for (p = a; l < p; p += c) d.push(t[p]);
              return d;
            case "Projection":
              var h = this.visit(e.children[0], t);
              if (!_(h)) return null;
              for (x = [], p = 0; p < h.length; p++) null !== (i = this.visit(e.children[1], h[p])) && x.push(i);
              return x;
            case "ValueProjection":
              ...
              for (var u = function(e) {
                  ...
                  return n
                }(h), p = 0; p < u.length; p++) null !== (i = this.visit(e.children[1], u[p])) && x.push(i);
              return x;
            case "FilterProjection":
              if (!_(h = this.visit(e.children[0], t))) return null;
              var f = [],
                m = [];
              for (p = 0; p < h.length; p++) S(n = this.visit(e.children[2], h[p])) || f.push(h[p]);
              for (var g = 0; g < f.length; g++) null !== (i = this.visit(e.children[1], f[g])) && m.push(i);
              return m;
            case "Comparator":
            ...
            case D:
              ...
              if (!_(v)) return null;
              var y = [];
              for (p = 0; p < v.length; p++) _(i = v[p]) ? y.push.apply(y, i) : y.push(i);
              return y;
            case "Identity":
              return t;
            case "MultiSelectList":
              if (null === t) return null;
              for (x = [], p = 0; p < e.children.length; p++) x.push(this.visit(e.children[p], t));
              return x;
            case "MultiSelectHash":
              if (null === t) return null;
              var b, x = {};
              for (p = 0; p < e.children.length; p++) x[(b = e.children[p]).name] = this.visit(b.value, t);
              return x;
            case "OrExpression":
              return S(n = this.visit(e.children[0], t)) && (n = this.visit(e.children[1], t)), n;
            case "AndExpression":
              return !0 === S(o = this.visit(e.children[0], t)) ? o : this.visit(e.children[1], t);
            case "NotExpression":
            ...
            case "Function":
              var C = [];
              for (p = 0; p < e.children.length; p++) C.push(this.visit(e.children[p], t));
        ...
        computeSliceParams: function(e, t) {
          ...
          r = o < 0, n = null === n ? r ? e - 1 : 0 : this.capSliceRange(e, n, o), i = null === i ? r ? -1 : e : this.capSliceRange(e, i, o);
        ...
        _typeMatches: function(e, t, n) {
          ...
          if (e === s) {
            ...
            for (var o = 0; o < n.length; o++)
              if (!this._typeMatches(this._getTypeName(n[o]), i, n[o])) return !1;
            return !0
          }
        },
        ...
        _functionReverse: function(e) {
          if (this._getTypeName(e[0]) === d) {
            for (var t = e[0], n = "", i = t.length - 1; 0 <= i; i--) n += t[i];
            return n
          }
          e = e[0].slice(0);
          return e.reverse(), e
        ...
        _functionToString: function(e) {
          return this._getTypeName(e[0]) === d ? e[0] : JSON.stringify(e[0])
        },
        _functionToNumber: function(e) {
          var t, n = this._getTypeName(e[0]);
          return n === c ? e[0] : n !== d || (t = +e[0], isNaN(t)) ? null : t
        },
        ...
        _functionMaxBy: function(e) {
          for (var t, n, i = e[1], o = e[0], r = this.createKeyFunction(i, [c, d]), s = -1 / 0, a = 0; a < o.length; a++) s < (n = r(o[a])) && (s = n, t = o[a]);
          return t
        },
        _functionMinBy: function(e) {
          for (var t, n, i = e[1], o = e[0], r = this.createKeyFunction(i, [c, d]), s = 1 / 0, a = 0; a < o.length; a++)(n = r(o[a])) < s && (s = n, t = o[a]);
          return t
        },
        createKeyFunction: function(n, i) {
          ...
          return function(e) {
            ...
            if (i.indexOf(o._getTypeName(t)) < 0) {
              e = "TypeError: expected one of " + i + ", received " + o._getTypeName(t);
              throw new Error(e)
            }
            return t
          }
    ...
    function v(e, t, n) {
      if (!(this instanceof v)) throw new Error('JSONEditor constructor called without "new".');
      var i = u();
      if (-1 !== i && i < 9) throw new Error("Unsupported browser, IE9 or newer required. Please install the newest version of your browser.");
    ...
    "undefined" == typeof Promise && console.error("Promise undefined. Please load a Promise polyfill in the browser in order to use JSONEditor"), v.modes = {}, v.prototype.DEBOUNCE_INTERVAL = 150, v.VALID_OPTIONS = ["ajv", "schema", "schemaRefs", "templates", "ace", "theme", "autocomplete", "onChange", "onChangeJSON", "onChangeText", "onEditable", "onError", "onEvent", "onModeChange", "onNodeName", "onValidate", "onCreateMenu", "onSelectionChange", "onTextSelectionChange", "onClassName", "onFocus", "onBlur", "colorPicker", "onColorPicker", "timestampTag", "timestampFormat", "escapeUnicode", "history", "search", "mode", "modes", "name", "indentation", "sortObjectKeys", "navigationBar", "statusBar", "mainMenuBar", "languages", "language", "enableSort", "enableTransform", "limitDragging", "maxVisibleChilds", "onValidationError", "modalAnchor", "popupAnchor", "createQuery", "executeQuery", "queryDescription"], v.prototype._create = function(e, t, n) {
      ...
      n = this.options.mode || this.options.modes && this.options.modes[0] || "tree";
      this.setMode(n)
    }, v.prototype.destroy = function() {}, v.prototype.set = function(e) {
      this.json = e
      ...
      if (e !== this.options.mode || !this.create) {
        ...
        try {
          ...
          if (this.destroy(), c(this), d(this, o.mixin), this.create(t, n), this.setName(s), this[r ? "setText" : "set"](a), "function" == typeof o.load) try {
            o.load.call(this)
          } catch (e) {
            console.error(e)
          }
          if ("function" == typeof n.onModeChange && e !== i) try {
            n.onModeChange(e, i)
          } catch (e) {
            console.error(e)
          }
      ...
      if (e) {
        var n;
        try {
          this.options.ajv ? n = this.options.ajv : ((n = g({
            allErrors: !0,
            verbose: !0,
            schemaId: "auto",
            $data: !0
          })).addMetaSchema(o(! function() {
            var e = new Error("Cannot find module 'ajv/lib/refs/json-schema-draft-04.json'");
            throw e.code = "MODULE_NOT_FOUND", e
          }())), n.addMetaSchema(o(! function() {
    ...
    }, v.prototype.validate = function() {}, v.prototype.refresh = function() {}, v.registerMode = function(e) {
      var t;
      if (Array.isArray(e))
        ...
        var n = e.mode;
        if (n in v.modes) throw new Error('Mode "' + n + '" already registered');
        if ("function" != typeof e.mixin.create) throw new Error('Required function "create" missing on mixin');
        for (var i = ["setMode", "registerMode", "modes"], o = 0; o < i.length; o++)
          if ((t = i[o]) in e.mixin) throw new Error('Reserved property "' + t + '" not allowed in mixin');
        v.modes[n] = e
      }
    }, v.registerMode(r), v.registerMode(s), v.registerMode(a), v.ace = n, v.Ajv = g, v.VanillaPicker = i, v.showTransformModal = m, v.showSortModal = l, v.getInnerText = h, v.default = v, e.exports = v
  }, function(e, t) {
    window.ace.define("ace/theme/jsoneditor", ["require", "exports", "module", "ace/lib/dom"], function(e, t, n) {
    ...
    var E = function() {
      ...
      return e = k, (t = [{
        ...
        value: function(e) {
          if (e) {
            for (var t = this, n = 0; n < e.length && t; n++) var i = e[n],
              t = t.childs[i];
            return t
          }
        }
        ...
        key: "findNode",
        value: function(e) {
          for (var n = Object(N.parsePath)(e), i = this; i && 0 < n.length;) ! function() {
            var t = n.shift();
            if ("number" == typeof t) {
        ...
        value: function() {
          ...
          if (i && this.dom && this.dom.tr) {
            Object(N.addClassName)(this.dom.tr, "jsoneditor-validation-error"), e || (e = document.createElement("td"), this.dom.tdError = e, this.dom.tdValue.parentNode.appendChild(e));
            var o = document.createElement("button");
            o.type = "button", o.className = "jsoneditor-button jsoneditor-schema-error";
            var t = function() {
              ...
              s = function(e) {
                ...
                n.dom.popupAnchor = Object(h.a)(o, n.editor.getPopupAnchor(), r, e);
                e = o.getBoundingClientRect(), t = 120 < t.getBoundingClientRect().width - e.x ? "jsoneditor-above" : "jsoneditor-left", e = document.createElement("div");
            ...
            e.appendChild(o)
          } else this.dom.tr && Object(N.removeClassName)(this.dom.tr, "jsoneditor-validation-error"), e && (this.dom.tdError.parentNode.removeChild(this.dom.tdError), delete this.dom.tdError)
        }
      }, {
        key: "getIndex",
        value: function() {
        ...
        key: "setValue",
        value: function(e, t) {
          var n, i, o, r, s, a, l, c = this.childs;
          ...
          if ("array" === this.type) {
            for (this.childs || (this.childs = []), i = 0; i < e.length; i++) void 0 === (s = e[i]) || s instanceof Function || (i < this.childs.length ? ((n = this.childs[i]).fieldEditable = !1, n.index = i, n.setValue(s)) : (n = new k(this.editor, {
              value: s
            }), r = i < this.getMaxVisibleChilds(), this.appendChild(n, r, !1)));
            for (o = this.childs.length; o >= e.length; o--) this.removeChild(this.childs[o], !1)
          } else if ("object" === this.type) {
            for (this.childs || (this.childs = []), o = this.childs.length - 1; 0 <= o; o--) C(e, this.childs[o].field) || this.removeChild(this.childs[o], !1);
            for (var d in i = 0, e) C(e, d) && (void 0 === (s = e[d]) || s instanceof Function || ((l = this.findChildByProperty(d)) ? (l.setField(d, !0), l.setValue(s)) : (a = new k(this.editor, {
              field: d,
              value: s
            }), l = i < this.getMaxVisibleChilds(), this.appendChild(a, l, !1))), i++);
          ...
          Array.isArray(c) !== Array.isArray(this.childs) && this.recreateDom(), this.updateDom({
            updateIndexes: !0
        ...
        value: function(e) {
          var t, n, i, o, r, s = this.childs;
          if (this.type = e.type, "array" === e.type) {
            for (this.childs || (this.childs = []), o = 0; o < e.childs.length; o++) void 0 === (t = e.childs[o]) || t instanceof Function || (o < this.childs.length ? ((n = this.childs[o]).fieldEditable = !1, n.index = o, n.setInternalValue(t)) : (n = new k(this.editor, {
              internalValue: t
            ...
            for (this.childs || (this.childs = []), o = 0; o < e.childs.length; o++) void 0 === (t = e.childs[o]) || t instanceof Function || (o < this.childs.length ? (delete(n = this.childs[o]).index, n.setField(t.field, !0), n.setInternalValue(t.value)) : (n = new k(this.editor, {
              field: t.field,
        ...
        key: "clone",
        value: function() {
          var t, n = new k(this.editor);
          return n.type = this.type, n.field = this.field, n.fieldInnerText = this.fieldInnerText, n.fieldEditable = this.fieldEditable, n.previousField = this.previousField, n.value = this.value, n.valueInnerText = this.valueInnerText, n.previousValue = this.previousValue, n.expanded = this.expanded, n.visibleChilds = this.visibleChilds, this.childs ? (t = [], this.childs.forEach(function(e) {
            e = e.clone();
            e.setParent(n), t.push(e)
          }), n.childs = t) : n.childs = void 0, n
        }
      }, {
        key: "expand",
        value: function(t) {
        ...
        value: function() {
          ...
          if (e && this.expanded) {
            ...
            if (n) {
              e = this.getAppendDom();
              e.parentNode || ((o = t.nextSibling) ? n.insertBefore(e, o) : n.appendChild(e));
              for (var i = Math.min(this.childs.length, this.visibleChilds), o = this._getNextTr(), r = 0; r < i; r++) {
                var s = this.childs[r];
                s.getDom().parentNode || n.insertBefore(s.getDom(), o), s.showChilds()
              }
              e = this.getShowMoreDom();
              o = this._getNextTr(), e.parentNode || n.insertBefore(e, o), this.showMore.updateDom()
            }
          }
        }
      }, {
        ...
        value: function() {
          var e;
          this.dom.field && this.editor && this.editor.options && "function" == typeof this.editor.options.onClassName && this.dom.tree && (Object(N.removeAllClassNames)(this.dom.tree), e = this.editor.options.onClassName({
            path: this.getPath(),
            field: this.field,
            value: this.value
          }) || "", Object(N.addClassName)(this.dom.tree, "jsoneditor-values " + e))
        }
      }, {
        key: "recursivelyUpdateCssClassesOnNodes",
        value: function() {
          if (this._updateCssClassName(), Array.isArray(this.childs))
            for (var e = 0; e < this.childs.length; e++) this.childs[e].recursivelyUpdateCssClassesOnNodes()
        }
      }, {
        key: "expandTo",
        value: function() {
        ...
        value: function(e, t, n) {
          var i, o, r;
          this._hasChilds() && ((i = this.dom.tr ? this.dom.tr.parentNode : void 0) && ((o = document.createElement("tr")).style.height = i.clientHeight + "px", i.appendChild(o)), e.parent && e.parent.removeChild(e), t instanceof I || !t ? this.childs.length + 1 > this.visibleChilds ? (r = this.childs[this.visibleChilds - 1], this.insertBefore(e, r, n)) : this.appendChild(e, !0, n) : this.insertBefore(e, t, n), i && o && i.removeChild(o))
        }
      }, {
        key: "insertBefore",
        value: function(e, t, n) {
          if (this._hasChilds()) {
            if (this.visibleChilds++, "object" === this.type && void 0 === e.field && e.setField(""), t === this.append) e.setParent(this), e.fieldEditable = "object" === this.type, this.childs.push(e);
            else {
            ...
            var o;
            this.expanded && (o = e.getDom(), t = (i = t.getDom()) ? i.parentNode : void 0, i && t && t.insertBefore(o, i), e.showChilds(), this.showChilds()), !1 !== n && (this.updateDom({
              updateIndexes: !0
            }), e.updateDom({
              recurse: !0
            }))
        ...
        key: "focus",
        value: function(e) {
          if (k.focusElement = e, this.dom.tr && this.dom.tr.parentNode) {
            var t = this.dom;
            switch (e) {
              case "drag":
                (t.drag || t.menu).focus();
              ...
              case "menu":
                ...
                break;
              case "expand":
                this._hasChilds() ? t.expand.focus() : t.field && this.fieldEditable ? (t.field.focus(), Object(N.selectContentEditable)(t.field)) : t.value && !this._hasChilds() ? (t.value.focus(), Object(N.selectContentEditable)(t.value)) : t.menu.focus();
                break;
              case "field":
                t.field && this.fieldEditable ? (t.field.focus(), Object(N.selectContentEditable)(t.field)) : t.value && !this._hasChilds() ? (t.value.focus(), Object(N.selectContentEditable)(t.value)) : (this._hasChilds() ? t.expand : t.menu).focus();
                break;
              case "value":
              default:
                t.select ? t.select.focus() : t.value && !this._hasChilds() ? (t.value.focus(), Object(N.selectContentEditable)(t.value)) : t.field && this.fieldEditable ? (t.field.focus(), Object(N.selectContentEditable)(t.field)) : (this._hasChilds() ? t.expand : t.menu).focus()
            }
          }
        }
      }, {
        ...
        value: function(e, t) {
          if (this.childs) {
            ...
            if (-1 !== n) {
              n < this.visibleChilds && this.expanded && this.visibleChilds--, e.hide(), delete e.searchField, delete e.searchValue;
              n = this.childs.splice(n, 1)[0];
              return n.parent = null, !1 !== t && this.updateDom({
                updateIndexes: !0
              }), n
            }
          }
        ...
        value: function(e) {
          ...
          }), "string" !== n && "auto" !== n || (this.expanded = !0)) : this.expanded = !1, this._attachToDom(t)) : this.type = e, "auto" !== e && "string" !== e || (this.value = "string" === e ? String(this.value) : Object(N.parseString)(String(this.value)), this.focus()), this.updateDom({
            updateIndexes: !0
          }))
        }
      }, {
        ...
        key: "_getDomValue",
        value: function() {
          if (this._clearValueError(), this.dom.value && "array" !== this.type && "object" !== this.type && (this.valueInnerText = Object(N.getInnerText)(this.dom.value), "" === this.valueInnerText && "" !== this.dom.value.innerHTML && (this.dom.value.textContent = "")), void 0 !== this.valueInnerText) try {
            var e;
            (e = "string" === this.type ? this._unescapeHTML(this.valueInnerText) : (e = this._unescapeHTML(this.valueInnerText), Object(N.parseString)(e))) !== this.value && (this.value = e, this._debouncedOnChangeValue())
          } catch (e) {
        ...
        value: function() {
          ...
          e.range && (t = Object(N.textDiff)(String(this.value), String(this.previousValue)), e.range.startOffset = t.start, e.range.endOffset = t.end);
          var t, n = this.editor.getDomSelection();
          n.range && (t = Object(N.textDiff)(String(this.previousValue), String(this.value)), n.range.startOffset = t.start, n.range.endOffset = t.end), this.editor._onAction("editValue", {
        ...
        value: function() {
          ...
          e.range && (n = Object(N.textDiff)(this.field, t), e.range.startOffset = n.start, e.range.endOffset = n.end);
          var n = this.editor.getDomSelection();
          n.range && (t = Object(N.textDiff)(t, this.field), n.range.startOffset = t.start, n.range.endOffset = t.end), this.editor._onAction("editField", {
        ...
        value: function() {
          ...
          if (e) {
            var t = ["jsoneditor-value"],
              n = this.value,
              i = "auto" === this.type ? Object(N.getType)(n) : this.type,
            ...
            if (t.push("jsoneditor-" + i), o && t.push("jsoneditor-url"), "" === String(this.value) && "array" !== this.type && "object" !== this.type && t.push("jsoneditor-empty"), this.searchValueActive && t.push("jsoneditor-highlight-active"), this.searchValue && t.push("jsoneditor-highlight"), e.className = t.join(" "), "array" === i || "object" === i ? (t = this.childs ? this.childs.length : 0, e.title = this.type + " containing " + t + " items") : o && this.editable.value ? e.title = Object(l.c)("openUrl") : e.title = "", "boolean" === i && this.editable.value ? (this.dom.checkbox || (this.dom.checkbox = document.createElement("input"), this.dom.checkbox.type = "checkbox", this.dom.tdCheckbox = document.createElement("td"), this.dom.tdCheckbox.className = "jsoneditor-tree", this.dom.tdCheckbox.appendChild(this.dom.checkbox), this.dom.tdValue.parentNode.insertBefore(this.dom.tdCheckbox, this.dom.tdValue)), this.dom.checkbox.checked = this.value) : this.dom.tdCheckbox && (this.dom.tdCheckbox.parentNode.removeChild(this.dom.tdCheckbox), delete this.dom.tdCheckbox, delete this.dom.checkbox), this.enum && this.editable.value) {
              if (!this.dom.select) {
                ...
                r.value = "", r.textContent = "--", this.dom.select.appendChild(r);
              ...
              this.dom.select.value = -1 !== this.enum.indexOf(this.value) ? this.value : "", !this.schema || C(this.schema, "oneOf") || C(this.schema, "anyOf") || C(this.schema, "allOf") ? delete this.valueFieldHTML : (this.valueFieldHTML = this.dom.tdValue.innerHTML, this.dom.tdValue.style.visibility = "hidden", this.dom.tdValue.textContent = "")
            ...
            if (this.editable.value && this.editor.options.colorPicker && "string" == typeof n && Object(N.isValidColor)(n) ? (this.dom.color || (this.dom.color = document.createElement("div"), this.dom.color.className = "jsoneditor-color", this.dom.tdColor = document.createElement("td"), this.dom.tdColor.className = "jsoneditor-tree", this.dom.tdColor.appendChild(this.dom.color), this.dom.tdValue.parentNode.insertBefore(this.dom.tdColor, this.dom.tdValue)), Object(N.addClassName)(this.dom.value, "jsoneditor-color-value"), this.dom.color.style.backgroundColor = n) : this._deleteDomColor(), this._showTimestampTag()) {
              ...
              r = null;
              if ("function" == typeof this.editor.options.timestampFormat && (r = this.editor.options.timestampFormat({
                  field: this.field,
                  value: this.value,
                  path: this.getPath()
                })), r) {
        ...
        key: "_deleteDomColor",
        value: function() {
          this.dom.color && (this.dom.tdColor.parentNode.removeChild(this.dom.tdColor), delete this.dom.tdColor, delete this.dom.color, Object(N.removeClassName)(this.dom.value, "jsoneditor-color-value"))
        }
      }, {
        key: "_updateDomField",
        value: function() {
          var e, t = this.dom.field;
          t && ((e = Object(N.makeFieldTooltip)(this.schema, this.editor.options.language)) && (t.title = e), ("" === String(this.field) && this.parent && "array" !== this.parent.type ? Object(N.addClassName) : Object(N.removeClassName))(t, "jsoneditor-empty"), (this.searchFieldActive ? Object(N.addClassName) : Object(N.removeClassName))(t, "jsoneditor-highlight-active"), (this.searchField ? Object(N.addClassName) : Object(N.removeClassName))(t, "jsoneditor-highlight"), Object(N.stripFormatting)(t))
        }
      }, {
        key: "_getDomField",
        value: function(e) {
          if (this._clearFieldError(), this.dom.field && this.fieldEditable && (this.fieldInnerText = Object(N.getInnerText)(this.dom.field), "" === this.fieldInnerText && "" !== this.dom.field.innerHTML && (this.dom.field.textContent = "")), void 0 !== this.fieldInnerText) try {
            var t = this._unescapeHTML(this.fieldInnerText),
              n = this.parent.getFieldNames(this); - 1 !== n.indexOf(t) ? e ? (t = Object(N.findUniqueName)(t, n)) !== this.field && (this.field = t, this._debouncedOnChangeField()) : this._setFieldError(Object(l.c)("duplicateFieldError")) : t !== this.field && (this.field = t, this._debouncedOnChangeField())
          } catch (e) {
        ...
        value: function() {
          var e;
          !this.schema || void 0 === this.schema.default || this._hasChilds() || (e = this.dom.select || this.dom.value) && (this.value === this.schema.default ? (e.title = Object(l.c)("default"), Object(N.addClassName)(e, "jsoneditor-is-default"), Object(N.removeClassName)(e, "jsoneditor-is-not-default")) : (e.removeAttribute("title"), Object(N.removeClassName)(e, "jsoneditor-is-default"), Object(N.addClassName)(e, "jsoneditor-is-not-default")))
        }
      }, {
        ...
        value: function() {
          ...
          if ("function" != typeof e) return !0 === e && Object(N.isTimestamp)(this.field, this.value);
          e = e({
            field: this.field,
            value: this.value,
            path: this.getPath()
          });
          return "boolean" == typeof e ? e : Object(N.isTimestamp)(this.field, this.value)
        }
      }, {
        key: "clearDom",
        value: function() {
        ...
        value: function() {
          var e, t = this.dom;
          if (t.tr) return t.tr;
          this._updateEditability(), t.tr = document.createElement("tr"), "tree" === (t.tr.node = this).editor.options.mode && (e = document.createElement("td"), this.editable.field && this.parent && ((n = document.createElement("button")).type = "button", (t.drag = n).className = "jsoneditor-button jsoneditor-dragarea", n.title = Object(l.c)("drag"), e.appendChild(n)), t.tr.appendChild(e), n = document.createElement("td"), (e = document.createElement("button")).type = "button", (t.menu = e).className = "jsoneditor-button jsoneditor-contextmenu-button", e.title = Object(l.c)("actionsMenu"), n.appendChild(t.menu), t.tr.appendChild(n));
          var n = document.createElement("td");
          return t.tr.appendChild(n), t.tree = this._createDomTree(), n.appendChild(t.tree), this.updateDom({
            updateIndexes: !0
          }), t.tr
        }
      }, {
        ...
        key: "setHighlight",
        value: function(t) {
          this.dom.tr && ((t ? Object(N.addClassName) : Object(N.removeClassName))(this.dom.tr, "jsoneditor-highlight"), this.append && this.append.setHighlight(t), this.childs && this.childs.forEach(function(e) {
            e.setHighlight(t)
          }))
        }
      }, {
        ...
        key: "_updateSchema",
        value: function() {
          this.editor && this.editor.options && (this.schema = this.editor.options.schema ? k._findSchema(this.editor.options.schema, this.editor.options.schemaRefs || {}, this.getPath()) : null, this.schema ? this.enum = k._findEnum(this.schema) : delete this.enum)
        }
      }, {
        ...
        value: function() {
          ...
          return e.type = "button", this._hasChilds() ? (e.className = this.expanded ? "jsoneditor-button jsoneditor-expanded" : "jsoneditor-button jsoneditor-collapsed", e.title = Object(l.c)("expandTitle")) : (e.className = "jsoneditor-button jsoneditor-invisible", e.title = ""), e
        }
      }, {
        key: "_createDomTree",
        value: function() {
          ...
          n.className = "jsoneditor-tree", i.appendChild(n), e.expand = this._createDomExpandButton(), n.appendChild(e.expand), e.tdExpand = n;
          n = document.createElement("td");
          n.className = "jsoneditor-tree", i.appendChild(n), e.field = this._createDomField(), n.appendChild(e.field), e.tdField = n;
          n = document.createElement("td");
          n.className = "jsoneditor-tree", i.appendChild(n), "object" !== this.type && "array" !== this.type && (n.appendChild(document.createTextNode(":")), n.className = "jsoneditor-separator"), e.tdSeparator = n;
          n = document.createElement("td");
        ...
        value: function(e) {
          var t, n = e.type,
            ...
            r = this,
            s = this._hasChilds();
          i !== o.drag && i !== o.menu || ("mouseover" === n ? this.editor.highlighter.highlight(this) : "mouseout" === n && this.editor.highlighter.unhighlight()), "click" === n && i === o.menu && ((t = r.editor.highlighter).highlight(r), t.lock(), Object(N.addClassName)(o.menu, "jsoneditor-selected"), this.showContextMenu(o.menu, function() {
            Object(N.removeClassName)(o.menu, "jsoneditor-selected"), t.unlock(), t.unhighlight()
          })), "click" === n && i === o.expand && s && (h = e.ctrlKey, this._onExpand(h)), "click" !== n || e.target !== r.dom.tdColor && e.target !== r.dom.color || this._showColorPicker(), "change" === n && i === o.checkbox && (this.dom.value.textContent = String(!this.value), this._getDomValue(), this._updateDomDefault()), "change" === n && i === o.select && (this.dom.value.innerHTML = this._escapeHTML(o.select.value), this._getDomValue(), this._updateDomValue());
          var a = o.value;
          if (i === a) switch (n) {
            case "blur":
            case "change":
              ...
              l !== this._unescapeHTML(Object(N.getInnerText)(a)) && (a.innerHTML = l);
              break;
            case "input":
            ...
            case "mousedown":
              ...
              break;
            case "click":
              e.ctrlKey && this.editable.value && Object(N.isUrl)(this.value) && (e.preventDefault(), window.open(this.value, "_blank", "noopener"));
              break;
            case "keyup":
              this._getDomValue(), this._updateDomValue();
              break;
          ...
          if (i === c) switch (n) {
            case "blur":
              ...
              d !== this._unescapeHTML(Object(N.getInnerText)(c)) && (c.innerHTML = d);
              break;
            case "input":
        ...
        key: "onKeyDown",
        value: function(e) {
          var t, n, i, o, r, s, a, l, c, d, h, u, p, f, m, g, v, y = e.which || e.keyCode,
          ...
          13 === y ? b === this.dom.value ? this.editable.value && !e.ctrlKey || Object(N.isUrl)(this.value) && (window.open(this.value, "_blank", "noopener"), _ = !0) : b === this.dom.expand && this._hasChilds() && (u = e.ctrlKey, this._onExpand(u), b.focus(), _ = !0) : 68 === y ? x && T && (k.onDuplicate(w), _ = !0) : 69 === y ? x && (this._onExpand(C), b.focus(), _ = !0) : 77 === y && T ? x && (this.showContextMenu(b), _ = !0) : 46 === y && T ? x && (k.onRemove(w), _ = !0) : 45 === y && T ? x && !C ? (this._onInsertBefore(), _ = !0) : x && C && (this._onInsertAfter(), _ = !0) : 35 === y ? E && ((u = this._lastNode()) && u.focus(k.focusElement || this._getElementName(b)), _ = !0) : 36 === y ? E && ((p = this._firstNode()) && p.focus(k.focusElement || this._getElementName(b)), _ = !0) : 37 === y ? E && !C ? ((p = this._previousElement(b)) && this.focus(this._getElementName(p)), _ = !0) : E && C && T && (f = j.expanded ? (f = j.getAppendDom()) ? f.nextSibling : void 0 : j.getDom().nextSibling) && (n = k.getNodeFromTarget(f), f = f.nextSibling, m = k.getNodeFromTarget(f), n && n instanceof I && 1 !== j.parent.childs.length && m && m.parent && (i = this.editor.getDomSelection(), o = (r = S.parent).childs[j.getIndex() + 1] || r.append, s = S.getIndex(), a = m.getIndex(), l = r.getInternalPath(), c = m.parent.getInternalPath(), w.forEach(function(e) {
            ...
            oldSelection: i,
            newSelection: this.editor.getDomSelection()
          })), _ = !0)), _ && (e.preventDefault(), e.stopPropagation())
        }
      }, {
        key: "_onExpand",
        value: function(e) {
          var t, n, i;
          e && (i = (n = (t = this.dom.tr.parentNode).parentNode).scrollTop, n.removeChild(t)), this.expanded ? this.collapse(e) : this.expand(e), e && (n.appendChild(t), n.scrollTop = i)
        }
      }, {
        key: "_showColorPicker",
        value: function() {
          var t, e;
          "function" == typeof this.editor.options.onColorPicker && this.dom.color && ((t = this)._deleteDomColor(), t.updateDom(), e = Object(h.a)(this.dom.color, this.editor.getPopupAnchor()), this.editor.options.onColorPicker(e, this.value, function(e) {
        ...
        value: function(n, e, t) {
          var i, o = !(2 < arguments.length && void 0 !== t) || t;
          "string" == typeof n && (n = Object(N.parsePath)(n)), this._hasChilds() && (this.hideChilds(), t = this.childs, this.childs = this.childs.concat(), i = "desc" === e ? -1 : 1, "object" === this.type ? this.childs.sort(function(e, t) {
            return i * d()(e.field, t.field)
          }) : this.childs.sort(function(e, t) {
            e = e.getNestedChild(n), t = t.getNestedChild(n);
            if (!e) return i;
            if (!t) return -i;
            e = e.value, t = t.value;
            return "string" != typeof e && "string" != typeof t ? t < e ? i : e < t ? -i : 0 : i * d()(e, t)
        ...
        key: "getAppendDom",
        value: function() {
          return this.append || (this.append = new I(this.editor), this.append.setParent(this)), this.append.getDom()
        }
      }, {
        key: "getShowMoreDom",
        value: function() {
          return this.showMore || (this.showMore = new w(this.editor, this)), this.showMore.getDom()
        }
      }, {
        key: "nextSibling",
        value: function() {
        ...
        value: function() {
          var e = null,
            t = this.getDom();
          if (t && t.parentNode)
            for (var n = t; n = n.previousSibling, e = k.getNodeFromTarget(n), n && e && e instanceof I && !e.isVisible(););
          return e
        }
      }, {
        key: "_nextNode",
        value: function() {
          var e = null,
            t = this.getDom();
          if (t && t.parentNode)
            for (var n = t; n = n.nextSibling, e = k.getNodeFromTarget(n), n && e && e instanceof I && !e.isVisible(););
          return e
        }
      }, {
        key: "_firstNode",
        value: function() {
          var e = null,
            t = this.getDom();
          return t && t.parentNode && (t = t.parentNode.firstChild, e = k.getNodeFromTarget(t)), e
        }
      }, {
        key: "_lastNode",
        value: function() {
          var e = null,
            t = this.getDom();
          if (t && t.parentNode)
            for (var n = t.parentNode.lastChild, e = k.getNodeFromTarget(n); n && e && !e.isVisible();) n = n.previousSibling, e = k.getNodeFromTarget(n);
          return e
        }
      }, {
        ...
        value: function(e, t) {
          ...
          })), this.parent && this.parent._hasChilds() && (r.length && r.push({
            type: "separator"
          }), n = o.parent.childs, o === n[n.length - 1] && (i = [{
            text: Object(l.c)("auto"),
          ...
          }))), this.editor.options.onCreateMenu && (i = o.getPath(), r = this.editor.options.onCreateMenu(r, {
            type: "single",
            path: i,
            paths: [i]
          })), new s.a(r, {
        ...
        value: function() {
          var n = this,
            ...
            t = this.getValue();
          Object(u.showSortModal)(e, t, function(e) {
            var t = e.path,
        ...
        key: "_getType",
        value: function(e) {
          return e instanceof Array ? "array" : e instanceof Object ? "object" : "string" == typeof e && "string" != typeof Object(N.parseString)(e) ? "string" : "auto"
        }
      }, {
        key: "_escapeHTML",
        value: function(e) {
          ...
          return !0 === this.editor.options.escapeUnicode && (e = Object(N.escapeUnicodeChars)(e)), e
        }
      }, {
        key: "_unescapeHTML",
        value: function(e) {
          e = '"' + this._escapeJSON(e) + '"';
          return Object(N.parse)(e).replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&nbsp;|\u00A0/g, " ").replace(/&amp;/g, "&")
        }
      }, {
        key: "_escapeJSON",
        value: function(e) {
        ...
        value: function() {
          if (this.expanded && (this.updateNodeName(), "undefined" !== this.childs))
            for (var e in this.childs) this.childs[e].recursivelyUpdateNodeName()
        }
      }]) && y(e.prototype, t), n && y(e, n), k
    }();
    E.prototype.DEBOUNCE_INTERVAL = 150, E.prototype.MAX_SEARCH_RESULTS = 999;
    var b = 100;
    ...
    E.focusElement = void 0, E.select = function(e) {
      setTimeout(function() {
      ...
      var n, i, o, r, s;
      0 !== t.length && (n = t[0], i = t[t.length - 1], o = n.parent, s = E.getNodeFromTarget(e.target), r = n.editor, s = Object(N.getAbsoluteTop)(s.dom.tr) - Object(N.getAbsoluteTop)(n.dom.tr), r.mousemove || (r.mousemove = Object(N.addEventListener)(e.view, "mousemove", function(e) {
        E.onDrag(t, e)
      })), r.mouseup || (r.mouseup = Object(N.addEventListener)(e.view, "mouseup", function(e) {
        E.onDragEnd(t, e)
      ...
      if (0 !== e.length) {
        var n, i, o, r, s, a, l = e[0].editor,
          ...
          m = p.offsetHeight;
        if (c < f) {
          for (x = p; x = x.previousSibling, i = E.getNodeFromTarget(x), r = x ? Object(N.getAbsoluteTop)(x) : 0, x && c < r;);
          i && !i.parent && (i = void 0), i || (x = (g = p.parentNode.firstChild) ? g.nextSibling : void 0, (i = E.getNodeFromTarget(x)) === u && (i = void 0)), i && i.isVisible() && (r = (x = i.dom.tr) ? Object(N.getAbsoluteTop)(x) : 0) + m < c && (i = void 0), !i || !1 !== l.options.limitDragging && i.parent !== e[0].parent || (e.forEach(function(e) {
            i.parent.moveBefore(e, i)
          }), h = !0)
        } else {
          var g, v = e[e.length - 1];
          if (m = (g = v.expanded && v.append ? v.append.getDom() : v.dom.tr) ? g.nextSibling : void 0) {
            for (s = Object(N.getAbsoluteTop)(m), n = m; o = E.getNodeFromTarget(n), n && (a = n.nextSibling ? Object(N.getAbsoluteTop)(n.nextSibling) : 0, a = n ? a - s : 0, o && o.parent.childs.length === e.length && o.parent.childs[e.length - 1] === v && (f += 27), n = n.nextSibling), n && f + a < c;);
            if (o && o.parent) {
              for (var m = d - l.drag.mouseX, m = Math.round(m / 24 / 2), y = l.drag.level + m, b = o.getLevel(), x = o.dom.tr && o.dom.tr.previousSibling; b < y && x;) {
                ...
                if (!C) {
                  ...
                  C = i.parent.childs;
                  if (C.length === e.length && C[e.length - 1] === v) break;
                  b = (o = E.getNodeFromTarget(x)).getLevel()
                }
                x = x.previousSibling
              }
              o instanceof I && !o.isVisible() && o.parent.showMore.isVisible() && (o = o._nextNode()), o && (!1 === l.options.limitDragging || o.parent === e[0].parent) && o.dom.tr && o.dom.tr !== g.nextSibling && (e.forEach(function(e) {
                o.parent.moveBefore(e, o)
              }), h = !0)
            }
          }
        }
        h && (l.drag.mouseX = d, l.drag.level = u.getLevel()), l.startAutoScroll(c), t.preventDefault()
      }
    }, E.onDragEnd = function(e, t) {
      if (!Array.isArray(e)) return E.onDrag([e], t);
      var n, i, o, r, s, a, l, c, d;
      0 !== e.length && (d = e[0], n = d.editor, e[0] && e[0].dom.menu.focus(), i = n.drag.oldParent.getInternalPath(), o = d.parent.getInternalPath(), r = n.drag.oldParent === d.parent, s = n.drag.oldNextNode.getIndex(), a = d.getIndex(), l = n.drag.oldParentPathRedo, c = n.drag.oldIndexRedo, d = r && c < a ? a + e.length : a, r && c === a || n._onAction("moveNodes", {
        count: e.length,
        fieldNames: e.map(O),
        oldParentPath: i,
        newParentPath: o,
      ...
      }), delete n.drag, n.mousemove && (Object(N.removeEventListener)(t.view, "mousemove", n.mousemove), delete n.mousemove), n.mouseup && (Object(N.removeEventListener)(t.view, "mouseup", n.mouseup), delete n.mouseup), n.stopAutoScroll(), t.preventDefault())
        ...
        for (s.s(); !(l = s.n()).done;) {
          if ("$ref" in (i = l.value) && "string" == typeof i.$ref) {
            ...
            if (a in t) i = t[a];
              ...
              if (!a.startsWith("#/")) throw Error("Unable to resolve reference ".concat(a));
              ...
              try {
                for (c.s(); !(d = c.n()).done;) {
                  var d = d.value;
                  if (!(d in i)) throw Error("Unable to resovle reference ".concat(a));
                  i = i[d]
                }
              } catch (e) {
                c.e(e)
          ...
          if ("string" != typeof r) {
            if ("number" == typeof r && "object" === v(i.items) && null !== i.items) return i = i.items, E._findSchema(e, t, o, i)
          } else {
            if ("object" === v(i.properties) && null !== i.properties && r in i.properties) return i = i.properties[r], E._findSchema(e, t, o, i);
            if ("object" === v(i.patternProperties) && null !== i.patternProperties)
              for (var h in i.patternProperties)
                if (r.match(h)) return i = i.patternProperties[h], E._findSchema(e, t, o, i)
          }
        }
      } catch (e) {
        s.e(e)
      ...
      var t, n, i, o, r, s;
      e && 0 < e.length && (t = (s = e[0]).parent, n = s.editor, i = s.getIndex(), n.highlighter.unhighlight(), o = n.getDomSelection(), E.blurNodes(e), r = n.getDomSelection(), s = e.map(x), e.forEach(function(e) {
        e.parent._remove(e)
      ...
      e && 0 < e.length && (t = e[e.length - 1], i = t.parent, (n = t.editor).deselect(n.multiselection.nodes), o = n.getDomSelection(), r = t, s = e.map(function(e) {
        var t, n = e.clone();
        return "object" === e.parent.type && (t = e.parent.getFieldNames(), n.field = Object(N.findUniqueName)(e.field, t)), i.insertAfter(n, r), r = n
      ...
      var t, n;
      Array.isArray(e) ? (t = (n = e[0]).parent, n = n.getIndex(), (t.childs[n + e.length] ? t.childs[n + e.length] : t.childs[n - 1] || t).focus()) : E.blurNodes([e])
    };
    var I = ((T.prototype = new E).getDom = function() {
      var e = this.dom;
      if (e.tr) return e.tr;
      this._updateEditability();
      var t = document.createElement("tr");
      t.className = "jsoneditor-append", t.node = this, e.tr = t, "tree" === this.editor.options.mode && (e.tdDrag = document.createElement("td"), i = document.createElement("td"), e.tdMenu = i, (n = document.createElement("button")).type = "button", n.className = "jsoneditor-button jsoneditor-contextmenu-button", n.title = "Click to open the actions menu (Ctrl+M)", e.menu = n, i.appendChild(e.menu));
      var n = document.createElement("td"),
        i = document.createElement("div");
      return i.appendChild(document.createTextNode("(" + Object(l.c)("empty") + ")")), i.className = "jsoneditor-readonly", n.appendChild(i), e.td = n, e.text = i, this.updateDom(), t
      ...
      var i = t.text;
      i && (i.firstChild.nodeValue = "(" + Object(l.c)("empty") + " " + this.parent.type + ")");
      i = t.tr;
      ...
      this.editor.options.onCreateMenu && (i = n.parent.getPath(), o = this.editor.options.onCreateMenu(o, {
        type: "append",
        path: i,
        paths: [i]
      })), new s.a(o, {
      ...
      var t, n = e.type,
        i = e.target || e.srcElement,
        o = this.dom;
      i === o.menu && ("mouseover" === n ? this.editor.highlighter.highlight(this.parent) : "mouseout" === n && this.editor.highlighter.unhighlight()), "click" === n && i === o.menu && ((t = this.editor.highlighter).highlight(this.parent), t.lock(), Object(N.addClassName)(o.menu, "jsoneditor-selected"), this.showContextMenu(o.menu, function() {
        Object(N.removeClassName)(o.menu, "jsoneditor-selected"), t.unlock(), t.unhighlight()
    ...
    var w = ((S.prototype = new E).getDom = function() {
      return this.dom.tr || (this._updateEditability(), this.dom.tr || (n = (t = this).parent, (o = document.createElement("a")).appendChild(document.createTextNode(Object(l.c)("showMore"))), o.href = "#", o.onclick = function(e) {
      ...
      }, (r = document.createElement("a")).appendChild(document.createTextNode(Object(l.c)("showAll"))), r.href = "#", r.onclick = function(e) {
      ...
      return Object(l.c)("showMoreStatus", {
    ...
    var k = function() {
      function n(t) {
        function r(e) {
          ...
          if (!(e instanceof n)) throw new TypeError("Cannot call a class as a function")
        }(this), this.editor = t, this.history = [], this.index = -1, this.clear(), this.actions = {
          editField: {
            undo: function(e) {
          ...
          duplicateNodes: {
            ...
            redo: function(e) {
              ...
              e.paths.map(r).forEach(function(e) {
                var t, n = e.clone();
                "object" === i.type && (t = i.getFieldNames(), n.field = Object(N.findUniqueName)(e.field, t)), i.insertAfter(n, o), o = n
              })
            }
          },
          moveNodes: {
    ...
    var A = function() {
      function o(e, t) {
        ...
        t = document.createElement("div");
        (this.dom.input = t).className = "jsoneditor-frame", t.title = Object(l.c)("searchTitle"), e.appendChild(t);
        e = document.createElement("button");
        e.type = "button", e.className = "jsoneditor-refresh", t.appendChild(e);
        var i = document.createElement("input");
        i.type = "text", (this.dom.search = i).oninput = function(e) {
        ...
        e = document.createElement("button");
        e.type = "button", e.title = Object(l.c)("searchNextResultTitle"), e.className = "jsoneditor-next", e.onclick = function() {
          n.next()
        }, t.appendChild(e);
        e = document.createElement("button");
        e.type = "button", e.title = Object(l.c)("searchPreviousResultTitle"), e.className = "jsoneditor-previous", e.onclick = function() {
          n.previous()
        }, t.appendChild(e)
      }
      var e, t, n;
      return e = o, (t = [{
        ...
        value: function(e) {
          var t, n;
          this.results && (t = this.results.length - 1, (n = null !== this.resultIndex ? this.resultIndex - 1 : t) < 0 && (n = t), this._setActiveResult(n, e))
        }
      }, {
        key: "_setActiveResult",
        value: function(e, t) {
          var n;
          if (this.activeResult && (n = this.activeResult.node, "field" === this.activeResult.elem ? delete n.searchFieldActive : delete n.searchValueActive, n.updateDom()), !this.results || !this.results[e]) return this.resultIndex = void 0, void(this.activeResult = void 0);
          this.resultIndex = e;
          var i = this.results[this.resultIndex].node,
            o = this.results[this.resultIndex].elem;
          "field" === o ? i.searchFieldActive = !0 : i.searchValueActive = !0, this.activeResult = this.results[this.resultIndex], i.updateDom(), i.scrollTo(function() {
            t && i.focus(o)
          })
        }
      }, {
    ...
    var F = function() {
        function n(e, t) {
          ! function(e) {
            if (!(e instanceof n)) throw new TypeError("Cannot call a class as a function")
          }(this), e && (this.root = t, this.path = document.createElement("div"), this.path.className = "jsoneditor-treepath", this.path.setAttribute("tabindex", 0), this.contentMenuClicked = !1, e.appendChild(this.path), this.reset())
        }
        var e, t, i;
        return e = n, (t = [{
          key: "reset",
          ...
          value: function(o) {
            ...
            this.path.textContent = "", o && o.length && o.forEach(function(n, i) {
              ...
              t.className = "jsoneditor-treepath-element", t.innerText = n.name, t.onclick = function(e) {
                ...
                r.contentMenuClicked = !1, Object(N.addClassName)(r.path, "show-all"), r.path.style.width = r.path.parentNode.getBoundingClientRect().width - 10 + "px", r.path.onblur = function() {
                  if (r.contentMenuClicked) return r.contentMenuClicked = !1, void r.path.focus();
                  Object(N.removeClassName)(r.path, "show-all"), r.path.onblur = void 0, r.path.style.width = "", r.setPath(e)
                }
    ...
    t.create = function(e, t) {
      ...
      this.container = e, this.dom = {}, this.highlighter = new i, this.selection = void 0, this.multiselection = {
        nodes: []
      }, this.validateSchema = null, this.validationSequence = 0, this.errorNodes = [], this.lastSchemaErrors = void 0, this.node = null, this.focusTarget = null, this._setOptions(t), t.autocomplete && (this.autocomplete = function(s) {
        ...
        var u, p, f, n, m, g = {
            ...
            show: function(e, t, n) {
              ...
              this.startFrom = t, this.wrapper.remove(), this.elementHint && (this.elementHint.remove(), this.elementHint = null), "" === o && (o = window.getComputedStyle(e).getPropertyValue("font-size")), "" === r && (r = window.getComputedStyle(e).getPropertyValue("font-family")), c.style.marginLeft = "0", c.style.marginTop = e.getBoundingClientRect().height + "px", this.options = n.map(String), this.element !== e && (this.element = e, this.elementStyle = {
                ...
                i.element.focus()
              }, this.element.addEventListener && (this.element.removeEventListener("keydown", C), this.element.addEventListener("keydown", C, !1), this.element.removeEventListener("blur", E), this.element.addEventListener("blur", E, !1)), a.appendChild(this.elementHint), a.appendChild(c), e.parentElement.appendChild(a), this.repaint(e)
            },
            setText: function(e) {
            ...
            repaint: function(e) {
              ...
              for (var i = 0; i < t; i++) {
                ...
                if (!s.caseSensitive && 0 === o.toLowerCase().indexOf(n.toLowerCase()) || s.caseSensitive && 0 === o.indexOf(n)) {
                  this.elementHint.innerText = l + n + o.substring(n.length), this.elementHint.realInnerText = l + o;
                  break
                }
              }
              c.style.left = h(l) + "px", v.refresh(n, this.options), this.elementHint.style.width = h(this.elementHint.innerText) + 10 + "px", "hidden" === c.style.visibility || (this.elementHint.style.width = h(this.elementHint.innerText) + c.clientWidth + "px")
            }
          },
          v = (u = c, p = [], f = 0, n = -1, m = {
            rs: g,
            ...
            refresh: function(i, e) {
              u.style.visibility = "hidden", f = 0, u.textContent = "";
              var t = window.innerHeight || document.documentElement.clientHeight,
                n = u.parentNode.getBoundingClientRect(),
                o = n.top - 6,
                n = t - n.bottom - 6;
              p = [];
              var r = "function" == typeof s.filter ? s.filter : _[s.filter],
                e = r ? e.filter(function(e) {
                  return r(s.caseSensitive ? i : i.toLowerCase(), s.caseSensitive ? e : e.toLowerCase(), s)
                }) : [];
              0 !== (p = e.map(function(e) {
                var t = document.createElement("div");
                t.className = "item", t.onmouseover = y, t.onmouseout = b, t.onmousedown = x, t.__hint = e, t.textContent = "", t.appendChild(document.createTextNode(e.substring(0, i.length)));
                var n = document.createElement("b");
                return n.appendChild(document.createTextNode(e.substring(i.length))), t.appendChild(n), u.appendChild(t), t
              })).length && (1 === p.length && (i.toLowerCase() === p[0].__hint.toLowerCase() && !s.caseSensitive || i === p[0].__hint && s.caseSensitive) || p.length < 2 || (m.highlight(0), 3 * n < o ? (u.style.maxHeight = o + "px", u.style.top = "", u.style.bottom = "100%") : (u.style.top = "100%", u.style.bottom = "", u.style.maxHeight = n + "px"), u.style.visibility = "visible"))
            },
            highlight: function(e) {
              -1 !== n && p[n] && (p[n].className = "item"), p[e].className = "item hover", n = e
            },
            move: function(e) {
              return "hidden" === u.style.visibility ? "" : (f + e === -1 || f + e === p.length || (f += e, m.highlight(f)), p[f].__hint)
            },
        ...
        var C = function(e) {
            ...
            if (null != this.elementHint && 33 !== t && 34 !== t) {
              if (27 === t) return g.hideDropDown(), g.element.focus(), e.preventDefault(), void e.stopPropagation();
              var n = (n = this.element.innerText).replace("\n", "");
              if (0 <= s.confirmKeys.indexOf(t)) return 9 === t && 0 === this.elementHint.innerText.length && g.onTab(), void(0 < this.elementHint.innerText.length && this.element.innerText !== this.elementHint.realInnerText && (this.element.innerText = this.elementHint.realInnerText, g.hideDropDown(), d(this.element), 9 === t && (g.element.focus(), e.preventDefault(), e.stopPropagation())));
              if (13 !== t) {
                if (40 === t) {
                  var i = n.substring(this.startFrom),
                    o = v.move(1);
                  return "" === o && g.onArrowDown(), this.elementHint.innerText = l + i + o.substring(i.length), this.elementHint.realInnerText = l + o, e.preventDefault(), void e.stopPropagation()
                }
                38 === t && (n = n.substring(this.startFrom), "" === (r = v.move(-1)) && g.onArrowUp(), this.elementHint.innerText = l + n + r.substring(n.length), this.elementHint.realInnerText = l + r, e.preventDefault(), e.stopPropagation())
              } else if (0 === this.elementHint.innerText.length) g.onEnter();
              else {
                var r = "hidden" === c.style.visibility;
                if (v.hide(), r) return g.hideDropDown(), g.element.focus(), void g.onEnter();
                this.element.innerText = this.elementHint.realInnerText, g.hideDropDown(), d(this.element), e.preventDefault(), e.stopPropagation()
              }
            }
          }.bind(g),
          E = function() {
        ...
        return v.onmouseselection = function(e, t) {
          t.element.innerText = t.elementHint.innerText = l + e, t.hideDropDown(), window.setTimeout(function() {
            t.element.focus(), d(t.element)
          }, 1)
        }, g
      }(t.autocomplete)), this.options.history && "view" !== this.options.mode && (this.history = new k(this)), this._createFrame(), this._createTable()
    }, t.destroy = function() {
      ...
      this.options = {
        ...
        onColorPicker: function(e, t, n) {
          var i;
          M.a ? (i = e.getBoundingClientRect().top, i = Object(N.getWindow)(e).innerHeight - i < 300 && 300 < i, new M.a({
            parent: e,
            color: t,
            popup: i ? "top" : "bottom",
            onDone: function(e) {
      ...
      if (n) {
        ...
        try {
          ...
          this._validateCustom(e).then(function(e) {
            r === o.validationSequence && (e = [].concat(i, e || []), o._renderValidationErrors(e), "function" == typeof t.options.onValidationError && (Object(N.isValidationErrorChanged)(e, t.lastSchemaErrors) && t.options.onValidationError.call(t, e), t.lastSchemaErrors = e))
          }).catch(function(e) {
            console.error(e)
          })
        } catch (e) {
      ...
      this.errorNodes = t.map(function(e) {
        return {
          ...
          child: e[1],
          error: {
            message: "object" === e[0].type ? Object(l.c)("containsInvalidProperties") : Object(l.c)("containsInvalidItems")
          }
        }
      ...
      try {
        if (this.options.onValidate) {
          ...
          return (Object(N.isPromise)(t) ? t : Promise.resolve(t)).then(function(e) {
            return Array.isArray(e) ? e.filter(function(e) {
      ...
      var t, n, i;
      e && ("scrollTop" in e && this.scrollableContent && (this.scrollableContent.scrollTop = e.scrollTop), e.paths ? (t = this, i = e.paths.map(function(e) {
        return t.node.findNodeByInternalPath(e)
      }), this.select(i)) : (i = (n = e.path ? this.node.findNodeByInternalPath(e.path) : null) && e.domName ? n.dom[e.domName] : null, e.range && i ? (i = Object.assign({}, e.range, {
        container: i
      }), Object(N.setSelectionOffset)(i)) : n && n.focus()))
      ...
      return i && "DIV" !== i.container.nodeName && (i = null), i && i.container !== n && (i = null), i && delete i.container, {
      ...
      var i, t, o, r, s = this.scrollableContent;
      ...
      this.frameFocusTracker = new a.a(s), this.frame.onclick = function(e) {
        var t = e.target;
        n(e), "BUTTON" === t.nodeName && e.preventDefault()
      }, this.frame.oninput = n, this.frame.onchange = n, this.frame.onkeydown = n, this.frame.onkeyup = n, this.frame.oncut = n, this.frame.onpaste = n, this.frame.onmousedown = n, this.frame.onmouseup = n, this.frame.onmouseover = n, this.frame.onmouseout = n, Object(N.addEventListener)(this.frame, "focus", n, !0), Object(N.addEventListener)(this.frame, "blur", n, !0), this.frame.onfocusin = n, this.frame.onfocusout = n, this.options.mainMenuBar && (Object(N.addClassName)(this.contentOuter, "has-main-menu-bar"), this.menu = document.createElement("div"), this.menu.className = "jsoneditor-menu", this.frame.appendChild(this.menu), (s = document.createElement("button")).type = "button", s.className = "jsoneditor-expand-all", s.title = Object(l.c)("expandAll"), s.onclick = function() {
        t.expandAll()
      }, this.menu.appendChild(s), (s = document.createElement("button")).type = "button", s.title = Object(l.c)("collapseAll"), s.className = "jsoneditor-collapse-all", s.onclick = function() {
        t.collapseAll()
      }, this.menu.appendChild(s), this.options.enableSort && ((e = document.createElement("button")).type = "button", e.className = "jsoneditor-sort", e.title = Object(l.c)("sortTitleShort"), e.onclick = function() {
        t.node.showSortModal()
      }, this.menu.appendChild(e)), this.options.enableTransform && ((e = document.createElement("button")).type = "button", e.title = Object(l.c)("transformTitleShort"), e.className = "jsoneditor-transform", e.onclick = function() {
        t.node.showTransformModal()
      }, this.menu.appendChild(e)), this.history && ((i = document.createElement("button")).type = "button", i.className = "jsoneditor-undo jsoneditor-separator", i.title = Object(l.c)("undo"), i.onclick = function() {
        t._onUndo()
      }, this.menu.appendChild(i), this.dom.undo = i, (o = document.createElement("button")).type = "button", o.className = "jsoneditor-redo", o.title = Object(l.c)("redo"), o.onclick = function() {
        t._onRedo()
      ...
      }, this.history.onChange()), this.options && this.options.modes && this.options.modes.length && ((r = this).modeSwitcher = new c.a(this.menu, this.options.modes, this.options.mode, function(e) {
        r.setMode(e), r.modeSwitcher.focus()
      })), this.options.search && (this.searchBox = new A(this, this.menu))), this.options.navigationBar && (this.navBar = document.createElement("div"), this.navBar.className = "jsoneditor-navigation-bar nav-bar-empty", this.frame.appendChild(this.navBar), this.treePath = new F(this.navBar, this.getPopupAnchor()), this.treePath.onSectionSelected(this._onTreePathSectionSelected.bind(this)), this.treePath.onContextMenuItemSelected(this._onTreePathMenuItemSelected.bind(this)))
    }, t._onUndo = function() {
      ...
      if (!E.targetIsColorPicker(e.target)) {
        var t, n = E.getNodeFromTarget(e.target);
        if ("keydown" === e.type && this._onKeyDown(e), n && "focus" === e.type && (this.focusTarget = e.target, this.options.autocomplete && "focus" === this.options.autocomplete.trigger && this._showAutoComplete(e.target)), "mousedown" === e.type && this._startDragDistance(e), "mousemove" !== e.type && "mouseup" !== e.type && "click" !== e.type || this._updateDragDistance(e), n && this.options && this.options.navigationBar && n && ("keydown" === e.type || "mousedown" === e.type) && (t = this, setTimeout(function() {
          ...
          "mousedown" === e.type && E.onDragStart(this.multiselection.nodes, e)
        } else "mousedown" === e.type && Object(N.hasParentNode)(e.target, this.content) && (this.deselect(), n && e.target === n.dom.drag ? E.onDragStart(n, e) : n && (e.target === n.dom.field || e.target === n.dom.value || e.target === n.dom.select) || this._onMultiSelectStart(e));
        n && n.onEvent(e)
      }
      ...
      e && e.length ? (Object(N.removeClassName)(this.navBar, "nav-bar-empty"), n = [], e.forEach(function(e) {
        var t = {
          name: i(e),
          node: e,
          children: []
      ...
      }), this.treePath.setPath(n)) : Object(N.addClassName)(this.navBar, "nav-bar-empty")
      ...
      "tree" === this.options.mode && void 0 === this.options.onEditable && (this.multiselection = {
        ...
        nodes: []
      }, this._startDragDistance(e), (t = this).mousemove || (this.mousemove = Object(N.addEventListener)(e.view, "mousemove", function(e) {
        t._onMultiSelect(e)
      })), this.mouseup || (this.mouseup = Object(N.addEventListener)(e.view, "mouseup", function(e) {
        t._onMultiSelectEnd(e)
      })), e.preventDefault())
    }, t._onMultiSelect = function(e) {
      var t;
      e.preventDefault(), this._updateDragDistance(e), e.hasMoved && ((t = E.getNodeFromTarget(e.target)) && (null == this.multiselection.start && (this.multiselection.start = t), this.multiselection.end = t), this.deselect(), e = this.multiselection.start, t = this.multiselection.end || this.multiselection.start, e && t && (this.multiselection.nodes = this._findTopLevelNodes(e, t), this.multiselection.nodes && this.multiselection.nodes.length && (t = this.multiselection.nodes[0], this.multiselection.start === t || this.multiselection.start.isDescendantOf(t) ? this.multiselection.direction = "down" : this.multiselection.direction = "up"), this.select(this.multiselection.nodes)))
    }, t._onMultiSelectEnd = function(e) {
      this.multiselection.nodes[0] && this.multiselection.nodes[0].dom.menu.focus(), this.multiselection.start = null, this.multiselection.end = null, this.mousemove && (Object(N.removeEventListener)(e.view, "mousemove", this.mousemove), delete this.mousemove), this.mouseup && (Object(N.removeEventListener)(e.view, "mouseup", this.mouseup), delete this.mouseup)
      ...
      var r = n[o - 1],
        s = n[o],
        e = i[o];
      if (s && e || (r.parent ? r = (e = s = r).parent : (s = r.childs[0], e = r.childs[r.childs.length - 1])), r && s && e) {
        t = r.childs.indexOf(s), s = r.childs.indexOf(e), e = Math.min(t, s), s = Math.max(t, s);
        return r.childs.slice(e, s + 1)
      }
      return []
    }, t._showAutoComplete = function(t) {
      var n, i = E.getNodeFromTarget(t),
        o = "";
      0 <= t.className.indexOf("jsoneditor-value") && (o = "value"), 0 <= t.className.indexOf("jsoneditor-field") && (o = "field"), "" !== o && (n = this, setTimeout(function() {
        var e;
      ...
      9 === n && (t = this, setTimeout(function() {
        t.focusTarget !== l && Object(N.selectContentEditable)(t.focusTarget)
      ...
      "function" == typeof e && (this._selectionChangedHandler = Object(N.debounce)(e, this.DEBOUNCE_INTERVAL))
    ...
    "use strict";
    n.r(t), n.d(t, "previewModeMixins", function() {
      return m
    });
    var t = n(7),
      i = n.n(t),
    ...
    var l = function() {
        function i(e, t, n) {
          ...
          }(this), this.onChange = e, this.calculateItemSize = t || function() {
            return 1
          }, this.limit = n, this.items = [], this.index = -1
        }
        var e, t, n;
        return e = i, (t = [{
          key: "add",
    ...
    t.create = function(e) {
      ...
      void 0 === t.statusBar && (t.statusBar = !0), t.mainMenuBar = !1 !== t.mainMenuBar, t.enableSort = !1 !== t.enableSort, t.enableTransform = !1 !== t.enableTransform, t.createQuery = t.createQuery || d.a, t.executeQuery = t.executeQuery || d.b, "number" == typeof(this.options = t).indentation ? this.indentation = Number(t.indentation) : this.indentation = 2, Object(c.b)(this.options.languages), Object(c.a)(this.options.language), this.mode = "preview";
      var n = this;
      this.container = e, this.dom = {}, this.json = void 0, this.text = "", this._debouncedValidate = Object(f.debounce)(this.validate.bind(this), this.DEBOUNCE_INTERVAL), this.width = e.clientWidth, this.height = e.clientHeight, this.frame = document.createElement("div"), this.frame.className = "jsoneditor jsoneditor-mode-preview", this.frame.onclick = function(e) {
        e.preventDefault()
      };
      var i, e = {
        target: this.frame,
      ...
      this.frameFocusTracker = new r.a(e), this.content = document.createElement("div"), this.content.className = "jsoneditor-outer", this.dom.busy = document.createElement("div"), this.dom.busy.className = "jsoneditor-busy", this.dom.busyContent = document.createElement("span"), this.dom.busyContent.textContent = "busy...", this.dom.busy.appendChild(this.dom.busyContent), this.content.appendChild(this.dom.busy), this.dom.previewContent = document.createElement("pre"), this.dom.previewContent.className = "jsoneditor-preview", this.dom.previewText = document.createTextNode(""), this.dom.previewContent.appendChild(this.dom.previewText), this.content.appendChild(this.dom.previewContent), this.options.mainMenuBar && (Object(f.addClassName)(this.content, "has-main-menu-bar"), this.menu = document.createElement("div"), this.menu.className = "jsoneditor-menu", this.frame.appendChild(this.menu), (e = document.createElement("button")).type = "button", e.className = "jsoneditor-format", e.title = Object(c.c)("formatTitle"), this.menu.appendChild(e), e.onclick = function() {
      ...
      }, (e = document.createElement("button")).type = "button", e.className = "jsoneditor-compact", e.title = Object(c.c)("compactTitle"), this.menu.appendChild(e), e.onclick = function() {
        n.executeWithBusyMessage(function() {
          try {
            n.compact()
          } catch (e) {
      ...
      }, this.options.enableSort && ((e = document.createElement("button")).type = "button", e.className = "jsoneditor-sort", e.title = Object(c.c)("sortTitleShort"), e.onclick = function() {
        n._showSortModal()
      }, this.menu.appendChild(e)), this.options.enableTransform && ((i = document.createElement("button")).type = "button", i.title = Object(c.c)("transformTitleShort"), i.className = "jsoneditor-transform", i.onclick = function() {
        n._showTransformModal()
      }, this.dom.transform = i, this.menu.appendChild(i)), (i = document.createElement("button")).type = "button", i.className = "jsoneditor-repair", i.title = Object(c.c)("repairTitle"), this.menu.appendChild(i), !(i.onclick = function() {
        ...
        n.dom.undo.disabled = !n.history.canUndo(), n.dom.redo.disabled = !n.history.canRedo()
      }, function(e) {
        return 2 * e.text.length
      }, s.c), (i = document.createElement("button")).type = "button", i.className = "jsoneditor-undo jsoneditor-separator", i.title = Object(c.c)("undo"), i.onclick = function() {
        var e = n.history.undo();
        e && n._applyHistory(e)
      }, this.menu.appendChild(i), this.dom.undo = i, (i = document.createElement("button")).type = "button", i.className = "jsoneditor-redo", i.title = Object(c.c)("redo"), i.onclick = function() {
        var e = n.history.redo();
        e && n._applyHistory(e)
      }, this.menu.appendChild(i), this.dom.redo = i, this.history.onChange()), this.options && this.options.modes && this.options.modes.length && (this.modeSwitcher = new h.a(this.menu, this.options.modes, this.options.mode, function(e) {
        ...
        onFocusLine: null,
        onChangeHeight: function(e) {
          e = e + (n.dom.statusBar ? n.dom.statusBar.clientHeight : 0) + 1;
          n.content.style.marginBottom = -e + "px", n.content.style.paddingBottom = e + "px"
        }
      }), this.frame.appendChild(this.content), this.frame.appendChild(this.errorTable.getErrorTable()), this.container.appendChild(this.frame), t.statusBar && (Object(f.addClassName)(this.content, "has-status-bar"), t = document.createElement("div"), (this.dom.statusBar = t).className = "jsoneditor-statusbar", this.frame.appendChild(t), this.dom.fileSizeInfo = document.createElement("span"), this.dom.fileSizeInfo.className = "jsoneditor-size-info", this.dom.fileSizeInfo.innerText = "", t.appendChild(this.dom.fileSizeInfo), this.dom.arrayInfo = document.createElement("span"), this.dom.arrayInfo.className = "jsoneditor-size-info", this.dom.arrayInfo.innerText = "", t.appendChild(this.dom.arrayInfo), t.appendChild(this.errorTable.getErrorCounter()), t.appendChild(this.errorTable.getWarningIcon()), t.appendChild(this.errorTable.getErrorIcon())), this._renderPreview(), this.setSchema(this.options.schema, this.options.schemaRefs)
    }, t._renderPreview = function() {
      var e = this.getText();
      this.dom.previewText.nodeValue = Object(f.limitCharacters)(e, s.b), this.dom.fileSizeInfo && (this.dom.fileSizeInfo.innerText = "Size: " + Object(f.formatSize)(e.length)), this.dom.arrayInfo && (Array.isArray(this.json) ? this.dom.arrayInfo.innerText = "Array: " + this.json.length + " items" : this.dom.arrayInfo.innerText = "")
    }, t._onChange = function() {
      ...
      this.executeWithBusyMessage(function() {
        var e = r.options.modalAnchor || s.a,
          o = r.get();
        r._renderPreview(), Object(u.showSortModal)(e, o, function(i) {
          r.executeWithBusyMessage(function() {
            var e, t, n;
            e = o, t = i, Array.isArray(e) && (n = Object(f.sort)(e, t.path, t.direction), r.sortedBy = t, r._setAndFireOnChange(n)), Object(f.isObject)(e) && (e = Object(f.sortObjectKeys)(e, t.direction), r.sortedBy = t, r._setAndFireOnChange(e))
          }, "sorting...")
        }, r.sortedBy)
      }, "parsing...")
      ...
      this.executeWithBusyMessage(function() {
        var e = r.options,
          ...
          e = e.queryDescription,
          o = r.get();
        r._renderPreview(), Object(p.showTransformModal)({
          container: i || s.a,
          json: o,
          queryDescription: e,
          createQuery: t,
      ...
      var e;
      return void 0 === this.json && (e = this.getText(), this.json = Object(f.parse)(e)), this.json
    }, t.getText = function() {
      return void 0 === this.text && (this.text = JSON.stringify(this.json, null, this.indentation), !0 === this.options.escapeUnicode && (this.text = Object(f.escapeUnicodeChars)(this.text))), this.text
      ...
      var n;
      !0 === this.options.escapeUnicode ? this.text = Object(f.escapeUnicodeChars)(e) : this.text = e, this.json = t, this._renderPreview(), void 0 === this.json ? (n = this).executeWithBusyMessage(function() {
        try {
      ...
      var n;
      this.getText().length > s.d ? (n = this, Object(f.addClassName)(n.frame, "busy"), n.dom.busyContent.innerText = t, setTimeout(function() {
        e(), Object(f.removeClassName)(n.frame, "busy"), n.dom.busyContent.innerText = ""
      }, 100)) : e()
    }, t.validate = n.validate, t._renderErrors = n._renderErrors;
    var m = [{
      mode: "preview",
      mixin: t,
      data: "json"
